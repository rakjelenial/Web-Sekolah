! function (e, t) {
	...
	D.fn = D.prototype = {
		...
		for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || y(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
			if (null != (e = arguments[a]))
				for (t in e) n = s[t], s !== (i = e[t]) && (u && i && (D.isPlainObject(i) || (o = Array.isArray(i))) ? (r = o ? (o = !1, n && Array.isArray(n) ? n : []) : n && D.isPlainObject(n) ? n : {}, s[t] = D.extend(u, r, i)) : void 0 !== i && (s[t] = i));
		return s
	}, D.extend({
		...
		isPlainObject: function (e) {
			var t, n;
			return !(!e || "[object Object]" !== r.call(e)) && (!(t = i(e)) || "function" == typeof (n = g.call(t, "constructor") && t.constructor) && s.call(n) === u)
		},
	...
	var p = function (n) {
		var e, f, w, r, o, p, h, m, _, l, u, T, C, s, S, g, a, c, v, D = "sizzle" + 1 * new Date,
			y = n.document,
			x = 0,
			i = 0,
			d = se(),
		...
		function re(e, t, n, i) {
			...
			if (!i && ((t ? t.ownerDocument || t : y) !== C && T(t), t = t || C, S)) {
				if (11 !== d && (l = Z.exec(e)))
					if (o = l[1]) {
						if (9 === d) {
					...
					if (1 !== d) h = t, c = e;
						...
						for ((a = t.getAttribute("id")) ? a = a.replace(te, ne) : t.setAttribute("id", a = D), r = (u = p(e)).length; r--;) u[r] = "#" + a + " " + ve(u[r]);
						c = u.join(","), h = G.test(e) && me(t.parentNode) || t
					}
					if (c) try {
		...
		for (e in f = re.support = {}, o = re.isXML = function (e) {
				...
				return i !== C && 9 === i.nodeType && i.documentElement && (s = (C = i).documentElement, S = !o(C), y !== C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", ie, !1) : n.attachEvent && n.attachEvent("onunload", ie)), f.attributes = le(function (e) {
					return e.className = "i", !e.getAttribute("className")
				}), f.getElementsByTagName = le(function (e) {
					return e.appendChild(C.createComment("")), !e.getElementsByTagName("*").length
				}), f.getElementsByClassName = X.test(C.getElementsByClassName), f.getById = le(function (e) {
					return s.appendChild(e).id = D, !C.getElementsByName || !C.getElementsByName(D).length
				...
				})), (f.matchesSelector = X.test(c = s.matches || s.webkitMatchesSelector || s.mozMatchesSelector || s.oMatchesSelector || s.msMatchesSelector)) && le(function (e) {
					f.disconnectedMatch = c.call(e, "*"), c.call(e, "[s!='']:x"), a.push("!=", U)
					...
					return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !f.sortDetached && t.compareDocumentPosition(e) === n ? e === C || e.ownerDocument === y && v(y, e) ? -1 : t === C || t.ownerDocument === y && v(y, t) ? 1 : l ? H(l, e) - H(l, t) : 0 : 4 & n ? -1 : 1)
				} : function (e, t) {
					if (e === t) return u = !0, 0;
					var n, i = 0,
						o = e.parentNode,
						...
						s = [e],
						a = [t];
					if (!o || !r) return e === C ? -1 : t === C ? 1 : o ? -1 : r ? 1 : l ? H(l, e) - H(l, t) : 0;
				...
				if ((e.ownerDocument || e) !== C && T(e), t = t.replace(B, "='$1']"), f.matchesSelector && S && !E[t + " "] && (!a || !a.test(t)) && (!g || !g.test(t))) try {
					var n = c.call(e, t);
				...
				var n = w.attrHandle[t.toLowerCase()],
					i = n && A.call(w.attrHandle, t.toLowerCase()) ? n(e, t, !S) : void 0;
				...
				var t, n = [],
					i = 0,
					o = 0;
				if (u = !f.detectDuplicates, l = !f.sortStable && e.slice(0), e.sort(k), u) {
				...
				filter: {
						...
						return 1 === m && 0 === g ? function (e) {
							...
							if (c) {
								...
								if (l = [y ? c.firstChild : c.lastChild], y && d) {
									for (f = (a = (i = (o = (r = (s = c)[D] || (s[D] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === x && i[1]) && i[2], s = a && c.childNodes[a]; s = ++a && s && s[u] || (f = a = 0) || l.pop();)
										if (1 === s.nodeType && ++f && s === e) {
											o[p] = [x, a, f];
											break
										}
								} else if (d && (f = a = (i = (o = (r = (s = e)[D] || (s[D] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === x && i[1]), !1 === f)
									for (;
										(s = ++a && s && s[u] || (f = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== h : 1 !== s.nodeType) || !++f || (d && ((o = (r = s[D] || (s[D] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] = [x, f]), s !== e)););
					...
					PSEUDO: function (e, r) {
						...
						return s[D] ? s(r) : 1 < s.length ? (t = [e, e, "", r], w.setFilters.hasOwnProperty(e.toLowerCase()) ? ae(function (e, t) {
				...
				pseudos: {
					not: ae(function (e) {
						var i = [],
							o = [],
							a = h(e.replace(q, "$1"));
						return a[D] ? ae(function (e, t, n, i) {
					...
					lang: ae(function (n) {
						return z.test(n || "") || re.error("unsupported lang: " + n), n = n.replace(J, ee).toLowerCase(),
							function (e) {
								var t;
								do {
		...
		function ye(a, e, t) {
			...
			return e.first ? function (e, t, n) {
				...
				if (n) {
					...
					for (; e = e[l];)
						if (1 === e.nodeType || h)
							if (o = (r = e[D] || (e[D] = {}))[e.uniqueID] || (r[e.uniqueID] = {}), u && u === e.nodeName.toLowerCase()) e = e[l] || e;
							else {
								if ((i = o[c]) && i[0] === x && i[1] === d) return s[2] = i[2];
		...
		function _e(f, p, m, g, v, e) {
			return g && !g[D] && (g = _e(g)), v && !v[D] && (v = _e(v, e)), ae(function (e, t, n, i) {
				var o, r, s, a = [],
					l = [],
					u = t.length,
					c = e || function (e, t, n) {
					...
					h = !f || !e && p ? c : we(c, a, f, n, i),
					d = m ? v || (e ? f : u || g) ? [] : t : h;
				if (m && m(h, d, n, i), g)
					for (o = we(d, l), g(o, [], n, i), r = o.length; r--;)(s = o[r]) && (d[l[r]] = !(h[l[r]] = s));
				if (e) {
					if (v || f) {
						if (v) {
						...
						for (r = d.length; r--;)(s = d[r]) && -1 < (o = v ? H(e, s) : a[r]) && (e[o] = !(t[o] = s))
					}
				} else d = we(d === t ? d.splice(u, d.length) : d), v ? v(null, t, d, i) : O.apply(t, d)
			})
		}
		...
		function Te(e) {
			for (var o, t, n, i = e.length, r = w.relative[e[0].type], s = r || w.relative[" "], a = r ? 1 : 0, l = ye(function (e) {
					...
					var i = !r && (n || t !== _) || ((o = t).nodeType ? l(e, t, n) : u(e, t, n));
					return o = null, i
				}]; a < i; a++)
				if (t = w.relative[e[a].type]) c = [ye(be(c), t)];
					...
					if ((t = w.filter[e[a].type].apply(null, e[a].matches))[D]) {
						...
						return _e(1 < a && be(c), 1 < a && ve(e.slice(0, a - 1).concat({
							value: " " === e[a - 2].type ? "*" : ""
		...
		return ge.prototype = w.filters = w.pseudos, w.setFilters = new ge, p = re.tokenize = function (e, t) {
			...
			var n, g, v, y, b, i, o = [],
				...
				s = E[e + " "];
			if (!s) {
				for (t || (t = p(e)), n = t.length; n--;)(s = Te(t[n]))[D] ? o.push(s) : r.push(s);
				(s = E(e, (g = r, y = 0 < (v = o).length, b = 0 < g.length, i = function (e, t, n, i, o) {
					var r, s, a, l = 0,
						...
						m = f.length;
					for (o && (_ = t === C || t || o); u !== m && null != (r = f[u]); u++) {
						if (b && r) {
							for (s = 0, t || r.ownerDocument === C || (T(r), n = !S); a = g[s++];)
								if (a(r, t || C, n)) {
									i.push(r);
									break
								} o && (x = p)
					...
					if (l += u, y && u !== l) {
						...
						O.apply(i, h), o && !e && 0 < h.length && 1 < l + v.length && re.uniqueSort(i)
					}
					return o && (x = p, _ = d), c
				}, y ? ae(i) : i))).selector = e
			}
			...
			if (n = n || [], 1 === c.length) {
				if (2 < (r = c[0] = c[0].slice(0)).length && "ID" === (s = r[0]).type && 9 === t.nodeType && S && w.relative[r[1].type]) {
				...
				for (o = Y.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !w.relative[a = s.type]);)
					if ((l = w.find[a]) && (i = l(s.matches[0].replace(J, ee), G.test(r[0].type) && me(t.parentNode) || t))) {
						if (r.splice(o, 1), !(e = i.length && ve(r))) return O.apply(n, i), n;
						break
					}
			}
			return (u || h(e, c))(i, t, !S, n, !t || G.test(e) && me(t.parentNode) || t), n
		}, f.sortStable = D.split("").sort(k).join("") === D, f.detectDuplicates = !!u, T(), f.sortDetached = le(function (e) {
	...
	D.filter = function (e, t, n) {
		...
		find: function (e) {
			...
			for (n = this.pushStack([]), t = 0; t < i; t++) D.find(e, o[t], n);
		...
		is: function (e) {
			return !!M(this, "string" == typeof e && E.test(e) ? D(e) : e || [], !1).length
		}
	});
	var I, O = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
	(D.fn.init = function (e, t, n) {
		var i, o;
		if (!e) return this;
		if (n = n || I, "string" != typeof e) return e.nodeType ? (this[0] = e, this.length = 1, this) : y(e) ? void 0 !== n.ready ? n.ready(e) : e(D) : D.makeArray(e, this);
		if (!(i = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : O.exec(e)) || !i[1] && t) return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);
		if (i[1]) {
			if (t = t instanceof D ? t[0] : t, D.merge(this, D.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : S, !0)), A.test(i[1]) && D.isPlainObject(t))
				for (i in t) y(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
			return this
		}
		return (o = S.getElementById(i[2])) && (this[0] = o, this.length = 1), this
	}).prototype = D.fn, I = D(S);
	...
	D.fn.extend({
			...
			if (!E.test(e))
				for (; i < o; i++)
					for (n = this[i]; n && n !== t; n = n.parentNode)
						if (n.nodeType < 11 && (s ? -1 < s.index(n) : 1 === n.nodeType && D.find.matchesSelector(n, e))) {
							r.push(n);
							break
						} return this.pushStack(1 < r.length ? D.uniqueSort(r) : r)
		},
		index: function (e) {
			return e ? "string" == typeof e ? o.call(D(e), this[0]) : o.call(this, e.jquery ? e[0] : e) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1
		},
		add: function (e, t) {
		...
		contents: function (e) {
			return k(e, "iframe") ? e.contentDocument : (k(e, "template") && (e = e.content || e), D.merge([], e.childNodes))
		}
	}, function (i, o) {
		D.fn[i] = function (e, t) {
			var n = D.map(this, o, e);
			return "Until" !== i.slice(-5) && (t = e), t && "string" == typeof t && (n = D.filter(t, n)), 1 < this.length && (H[i] || D.uniqueSort(n), N.test(i) && n.reverse()), this.pushStack(n)
		}
	});
	var L = /[^\x20\t\r\n\f]+/g;
	...
	D.Callbacks = function (i) {
		var e, n;
		i = "string" == typeof i ? (e = i, n = {}, D.each(e.match(L) || [], function (e, t) {
			n[t] = !0
		}), n) : D.extend({}, i);
		var o, t, r, s, a = [],
			l = [],
				...
				add: function () {
					return a && (t && !o && (u = a.length - 1, l.push(t)), function n(e) {
						D.each(e, function (e, t) {
							y(t) ? i.unique && h.has(t) || a.push(t) : t && t.length && "string" !== _(t) && n(t)
						})
					}(arguments), t && !o && c()), this
				},
				remove: function () {
					return D.each(arguments, function (e, t) {
						for (var n; - 1 < (n = D.inArray(t, a, n));) a.splice(n, 1), n <= u && u--
					}), this
				},
				has: function (e) {
					return e ? -1 < D.inArray(e, a) : 0 < a.length
				},
				empty: function () {
					return a && (a = []), this
				},
								...
								var n = this,
									...
									e = function () {
										...
										if (!(o < l)) {
											...
											t = e && ("object" == typeof e || "function" == typeof e) && e.then, y(t) ? a ? t.call(e, u(l, r, P, a), u(l, r, j, a)) : (l++, t.call(e, u(l, r, P, a), u(l, r, j, a), u(l, r, P, r.notifyWith))) : (s !== P && (n = void 0, i = [e]), (a || r.resolveWith)(n, i))
										}
									},
									t = a ? e : function () {
										try {
											...
											D.Deferred.exceptionHook && D.Deferred.exceptionHook(e, t.stackTrace), l <= o + 1 && (s !== j && (n = void 0, i = [e]), r.rejectWith(n, i))
										}
									};
								o ? t() : (D.Deferred.getStackHook && (t.stackTrace = D.Deferred.getStackHook()), C.setTimeout(t))
							}
						}
						return D.Deferred(function (e) {
							r[0][3].add(u(0, e, y(i) ? i : P, e.notifyWith)), r[1][3].add(u(0, e, y(t) ? t : P)), r[2][3].add(u(0, e, y(n) ? n : j))
						}).promise()
					},
					promise: function (e) {
		...
		when: function (e) {
			...
			if (n <= 1 && (U(e, r.done(s(t)).resolve, r.reject, !n), "pending" === r.state() || y(o[t] && o[t].then))) return r.then();
	...
	function R() {
		S.removeEventListener("DOMContentLoaded", R), C.removeEventListener("load", R), D.ready()
	}
	D.fn.ready = function (e) {
		...
		readyWait: 1,
		ready: function (e) {
			(!0 === e ? --D.readyWait : D.isReady) || (D.isReady = !0) !== e && 0 < --D.readyWait || q.resolveWith(S, [D])
		}
	}), D.ready.then = q.then, "complete" === S.readyState || "loading" !== S.readyState && !S.documentElement.doScroll ? C.setTimeout(D.ready) : (S.addEventListener("DOMContentLoaded", R), C.addEventListener("load", R));
	var W = function (e, t, n, i, o, r, s) {
			...
			else if (void 0 !== i && (o = !0, y(i) || (s = !0), u && (t = s ? (t.call(e, i), null) : (u = t, function (e, t, n) {
					return u.call(D(e), n)
				})), t))
	...
	function Y(e) {
		return e.replace(B, "ms-").replace(V, z)
	}
	var K = function (e) {
	...
	Q.uid = 1, Q.prototype = {
		...
		remove: function (e, t) {
			...
			if (void 0 !== i) {
				if (void 0 !== t) {
					n = (t = Array.isArray(t) ? t.map(Y) : (t = Y(t)) in i ? [t] : t.match(L) || []).length;
					for (; n--;) delete i[t[n]]
	...
	D.extend({
		...
		data: function (n, e) {
			...
			if (void 0 !== n) return "object" == typeof n ? this.each(function () {
				...
				var t;
				if (r && void 0 === e) return void 0 !== (t = Z.get(r, n)) ? t : void 0 !== (t = ee(r, n)) ? t : void 0;
				this.each(function () {
					Z.set(this, n, e)
				})
			}, null, e, 1 < arguments.length, null, !0);
			if (this.length && (o = Z.get(r), 1 === r.nodeType && !X.get(r, "hasDataAttrs"))) {
		...
		queue: function (e, t, n) {
			var i;
			if (e) return t = (t || "fx") + "queue", i = X.get(e, t), n && (!i || Array.isArray(n) ? i = X.access(e, t, D.makeArray(n)) : i.push(n)), i || []
		},
	...
	function se(e, t, n, i) {
		...
		if (c && c[3] !== u) {
			for (l /= 2, u = u || c[3], c = +l || 1; s--;) D.style(e, t, c + u), (1 - r) * (1 - (r = a() / l || .5)) <= 0 && (s = 0), c /= r;
	...
	function le(e, t) {
		for (var n, i, o, r, s, a, l, u = [], c = 0, h = e.length; c < h; c++)(i = e[c]).style && (n = i.style.display, t ? ("none" === n && (u[c] = X.get(i, "display") || null, u[c] || (i.style.display = "")), "" === i.style.display && oe(i) && (u[c] = (l = s = r = void 0, s = (o = i).ownerDocument, a = o.nodeName, (l = ae[a]) || (r = s.body.appendChild(s.createElement(a)), l = D.css(r, "display"), r.parentNode.removeChild(r), "none" === l && (l = "block"), ae[a] = l)))) : "none" !== n && (u[c] = "none", X.set(i, "display", n)));
	...
	D.fn.extend({
		...
		toggle: function (e) {
			return "boolean" == typeof e ? e ? this.show() : this.hide() : this.each(function () {
				oe(this) ? D(this).show() : D(this).hide()
			})
		}
	});
	...
	function fe(e, t) {
		var n;
		return n = void 0 !== e.getElementsByTagName ? e.getElementsByTagName(t || "*") : void 0 !== e.querySelectorAll ? e.querySelectorAll(t || "*") : [], void 0 === t || t && k(e, t) ? D.merge([e], n) : n
	}
	...
	function ye(e, t, n, i, o) {
		for (var r, s, a, l, u, c, h = t.createDocumentFragment(), d = [], f = 0, p = e.length; f < p; f++)
			if ((r = e[f]) || 0 === r)
				if ("object" === _(r)) D.merge(d, r.nodeType ? [r] : r);
				else if (ve.test(r)) {
			for (s = s || h.appendChild(t.createElement("div")), a = (ce.exec(r) || ["", ""])[1].toLowerCase(), l = de[a] || de._default, s.innerHTML = l[1] + D.htmlPrefilter(r) + l[2], c = l[0]; c--;) s = s.lastChild;
			D.merge(d, s.childNodes), (s = h.firstChild).textContent = ""
		} else d.push(t.createTextNode(r));
		for (h.textContent = "", f = 0; r = d[f++];)
			if (i && -1 < D.inArray(r, i)) o && o.push(r);
			else if (u = D.contains(r.ownerDocument, r), s = fe(h.appendChild(r), "script"), u && pe(s), n)
	...
	function xe(e, t, n, i, o, r) {
		...
		return 1 === r && (s = o, (o = function (e) {
			...
			D.event.add(this, t, o, i, n)
		})
	}
	D.event = {
		global: {},
		add: function (t, e, n, i, o) {
			var r, s, a, l, u, c, h, d, f, p, m, g = X.get(t);
			if (g)
				for (n.handler && (n = (r = n).handler, o = r.selector), o && D.find.matchesSelector(be, o), n.guid || (n.guid = D.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function (e) {
						return void 0 !== D && D.event.triggered !== e.type ? D.event.dispatch.apply(t, arguments) : void 0
					}), u = (e = (e || "").match(L) || [""]).length; u--;) f = m = (a = Te.exec(e[u]) || [])[1], p = (a[2] || "").split(".").sort(), f && (h = D.event.special[f] || {}, f = (o ? h.delegateType : h.bindType) || f, h = D.event.special[f] || {}, c = D.extend({
					type: f,
					origType: m,
					data: i,
					handler: n,
					...
					namespace: p.join(".")
				}, r), (d = l[f]) || ((d = l[f] = []).delegateCount = 0, h.setup && !1 !== h.setup.call(t, i, p, s) || t.addEventListener && t.addEventListener(f, s)), h.add && (h.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)), o ? d.splice(d.delegateCount++, 0, c) : d.push(c), D.event.global[f] = !0)
		},
		remove: function (e, t, n, i, o) {
			var r, s, a, l, u, c, h, d, f, p, m, g = X.hasData(e) && X.get(e);
			if (g && (l = g.events)) {
				for (u = (t = (t || "").match(L) || [""]).length; u--;)
					if (f = m = (a = Te.exec(t[u]) || [])[1], p = (a[2] || "").split(".").sort(), f) {
						for (h = D.event.special[f] || {}, d = l[f = (i ? h.delegateType : h.bindType) || f] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = d.length; r--;) c = d[r], !o && m !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (d.splice(r, 1), c.selector && d.delegateCount--, h.remove && h.remove.call(e, c));
						s && !d.length && (h.teardown && !1 !== h.teardown.call(e, p, g.handle) || D.removeEvent(e, f, g.handle), delete l[f])
					} else
						for (f in l) D.event.remove(e, f + t[u], n, i, !0);
				D.isEmptyObject(l) && X.remove(e, "handle events")
			}
		},
		dispatch: function (e) {
			var t, n, i, o, r, s, a = D.event.fix(e),
				l = new Array(arguments.length),
				u = (X.get(this, "events") || {})[a.type] || [],
				c = D.event.special[a.type] || {};
			for (l[0] = a, t = 1; t < arguments.length; t++) l[t] = arguments[t];
			if (a.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
				for (s = D.event.handlers.call(this, a, u), t = 0;
					(o = s[t++]) && !a.isPropagationStopped();)
					for (a.currentTarget = o.elem, n = 0;
						(r = o.handlers[n++]) && !a.isImmediatePropagationStopped();) a.rnamespace && !a.rnamespace.test(r.namespace) || (a.handleObj = r, a.data = r.data, void 0 !== (i = ((D.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
			...
			if (l && u.nodeType && !("click" === e.type && 1 <= e.button))
				for (; u !== this; u = u.parentNode || this)
					if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
						for (r = [], s = {}, n = 0; n < l; n++) void 0 === s[o = (i = t[n]).selector + " "] && (s[o] = i.needsContext ? -1 < D(o, this).index(u) : D.find(o, this, null, [u]).length), s[o] && r.push(i);
						r.length && a.push({
							elem: u,
							handlers: r
						})
		...
		e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Ce : Se, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && D.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[D.expando] = !0
	}, D.Event.prototype = {
		constructor: D.Event,
		...
		D.event.special[e] = {
			...
			handle: function (e) {
				var t, n = e.relatedTarget,
					i = e.handleObj;
				return n && (n === this || D.contains(this, n)) || (e.type = i.origType, t = i.handler.apply(this, arguments), e.type = o), t
			}
		}
	}), D.fn.extend({
		on: function (e, t, n, i) {
	...
	function Ie(e, t) {
		return k(e, "table") && k(11 !== t.nodeType ? t : t.firstChild, "tr") && D(e).children("tbody")[0] || e
	}
	...
	function He(e, t) {
		var n, i, o, r, s, a, l, u;
		if (1 === t.nodeType) {
			if (X.hasData(e) && (r = X.access(e), s = X.set(t, r), u = r.events))
				for (o in delete s.handle, s.events = {}, u)
					for (n = 0, i = u[o].length; n < i; n++) D.event.add(t, o, u[o][n]);
			Z.hasData(e) && (a = Z.access(e), l = D.extend({}, a), Z.set(t, l))
		}
	}
	...
	function $e(n, i, o, r) {
		...
		var e, t, s, a, l, u, c = 0,
			...
			f = i[0],
			p = y(f);
		if (p || 1 < h && "string" == typeof f && !v.checkClone && Ae.test(f)) return n.each(function (e) {
			var t = n.eq(e);
			p && (i[0] = f.call(this, e, t.html())), $e(t, i, o, r)
		});
		if (h && (t = (e = ye(i, n[0].ownerDocument, !1, n, r)).firstChild, 1 === e.childNodes.length && (e = t), t || r)) {
			for (a = (s = D.map(fe(e, "script"), Oe)).length; c < h; c++) l = e, c !== d && (l = D.clone(l, !0, !0), a && D.merge(s, fe(l, "script"))), o.call(n[c], l, c);
			if (a)
				for (u = s[s.length - 1].ownerDocument, D.map(s, Ne), c = 0; c < a; c++) l = s[c], he.test(l.type || "") && !X.access(l, "globalEval") && D.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? D._evalUrl && D._evalUrl(l.src) : w(l.textContent.replace(Me, ""), u, l))
		}
		return n
	}

	function Le(e, t, n) {
		for (var i, o = t ? D.filter(t, e) : e, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || D.cleanData(fe(i)), i.parentNode && (n && D.contains(i.ownerDocument, i) && pe(fe(i, "script")), i.parentNode.removeChild(i));
		return e
	}
	D.extend({
		...
		clone: function (e, t, n) {
			var i, o, r, s, a, l, u, c = e.cloneNode(!0),
				h = D.contains(e.ownerDocument, e);
			if (!(v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || D.isXMLDoc(e)))
				for (s = fe(c), i = 0, o = (r = fe(e)).length; i < o; i++) a = r[i], l = s[i], void 0, "input" === (u = l.nodeName.toLowerCase()) && ue.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
			if (t)
				if (n)
					for (r = r || fe(e), s = s || fe(c), i = 0, o = r.length; i < o; i++) He(r[i], s[i]);
				else He(e, c);
			return 0 < (s = fe(c, "script")).length && pe(s, !h && fe(e, "script")), c
		},
		cleanData: function (e) {
			for (var t, n, i, o = D.event.special, r = 0; void 0 !== (n = e[r]); r++)
				if (K(n)) {
					if (t = n[X.expando]) {
						if (t.events)
							for (i in t.events) o[i] ? D.event.remove(n, i) : D.removeEvent(n, i, t.handle);
						n[X.expando] = void 0
					}
		...
		D.fn[e] = function (e) {
			for (var t, n = [], i = D(e), o = i.length - 1, r = 0; r <= o; r++) t = r === o ? this : this.clone(!0), D(i[r])[s](t), l.apply(n, t.get());
			return this.pushStack(n)
		}
	});
	var Pe = new RegExp("^(" + te + ")(?!px)[a-z%]+$", "i"),
		je = function (e) {
	...
	function Fe(e, t, n) {
		...
		return (n = n || je(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || D.contains(e.ownerDocument, e) || (s = D.style(e, t)), !v.pixelBoxStyles() && Pe.test(s) && Ue.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
	}
	...
	function Xe(e, t, n, i, o, r) {
		...
		for (; s < 4; s += 2) "margin" === n && (l += D.css(e, n + ie[s], !0, o)), i ? ("content" === n && (l -= D.css(e, "padding" + ie[s], !0, o)), "margin" !== n && (l -= D.css(e, "border" + ie[s] + "Width", !0, o))) : (l += D.css(e, "padding" + ie[s], !0, o), "padding" !== n ? l += D.css(e, "border" + ie[s] + "Width", !0, o) : a += D.css(e, "border" + ie[s] + "Width", !0, o));
	...
	function Ze(e, t, n) {
		...
		return s = s && (v.boxSizingReliable() || o === e.style[t]), ("auto" === o || !parseFloat(o) && "inline" === D.css(e, "display", !1, i)) && (o = e["offset" + t[0].toUpperCase() + t.slice(1)], s = !0), (o = parseFloat(o) || 0) + Xe(e, t, n || (r ? "border" : "content"), s, i, o) + "px"
	}
	...
	D.extend({
		...
		style: function (e, t, n, i) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				var o, r, s, a = Y(t),
					l = We.test(t),
					u = e.style;
				if (l || (t = Ke(a)), s = D.cssHooks[t] || D.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (o = s.get(e, !1, i)) ? o : u[t];
				"string" === (r = typeof n) && (o = ne.exec(n)) && o[1] && (n = se(e, t, o), r = "number"), null != n && n == n && ("number" === r && (n += o && o[3] || (D.cssNumber[a] ? "" : "px")), v.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? u.setProperty(t, n) : u[t] = n))
			}
		},
		css: function (e, t, n, i) {
			var o, r, s, a = Y(t);
			return We.test(t) || (t = Ke(a)), (s = D.cssHooks[t] || D.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = Fe(e, t, i)), "normal" === o && t in Ve && (o = Ve[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
		}
	}), D.each(["height", "width"], function (e, a) {
		D.cssHooks[a] = {
			get: function (e, t, n) {
				if (t) return !Re.test(D.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ze(e, a, n) : re(e, Be, function () {
					return Ze(e, a, n)
				})
			},
			set: function (e, t, n) {
				var i, o = je(e),
					r = "border-box" === D.css(e, "boxSizing", !1, o),
					s = n && Xe(e, a, n, r, o);
				return r && v.scrollboxSize() === o.position && (s -= Math.ceil(e["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(o[a]) - Xe(e, a, "border", !1, o) - .5)), s && (i = ne.exec(t)) && "px" !== (i[3] || "px") && (e.style[a] = t, t = D.css(e, a)), Qe(0, t, s)
			}
		}
	}), D.cssHooks.marginLeft = qe(v.reliableMarginLeft, function (e, t) {
		...
		}, "margin" !== o && (D.cssHooks[o + r].set = Qe)
	}), D.fn.extend({
		css: function (e, t) {
			return W(this, function (e, t, n) {
				var i, o, r = {},
					s = 0;
				if (Array.isArray(t)) {
					for (i = je(e), o = t.length; s < o; s++) r[t[s]] = D.css(e, t[s], !1, i);
					return r
				}
		...
		init: function (e, t, n, i, o, r) {
			this.elem = e, this.prop = n, this.easing = o || D.easing._default, this.options = t, this.start = this.now = this.cur(), this.end = i, this.unit = r || (D.cssNumber[n] ? "" : "px")
		},
		cur: function () {
	...
	function rt() {
		et && (!1 === S.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(rt) : C.setTimeout(rt, D.fx.interval), D.fx.tick())
	}
	...
	function ut(r, e, t) {
		var n, s, i = 0,
			...
			l = function () {
				if (s) return !1;
				for (var e = Je || st(), t = Math.max(0, u.startTime + u.duration - e), n = 1 - (t / u.duration || 0), i = 0, o = u.tweens.length; i < o; i++) u.tweens[i].run(n);
				return a.notifyWith(r, [u, n, t]), n < 1 && o ? t : (o || a.notifyWith(r, [u, 1, 0]), a.resolveWith(r, [u]), !1)
			},
			u = a.promise({
				elem: r,
				props: D.extend({}, e),
				...
				createTween: function (e, t) {
					var n = D.Tween(r, u.opts, e, t, u.opts.specialEasing[e] || u.opts.easing);
		...
		for (! function (e, t) {
				var n, i, o, r, s;
				for (n in e)
					if (o = t[i = Y(n)], r = e[n], Array.isArray(r) && (o = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), (s = D.cssHooks[i]) && "expand" in s)
						for (n in r = s.expand(r), delete e[i], r) n in e || (e[n] = r[n], t[n] = o);
					else t[i] = o
			}(c, u.opts.specialEasing); i < o; i++)
			if (n = ut.prefilters[i].call(u, r, c, u.opts)) return y(n.stop) && (D._queueHooks(u.elem, u.opts.queue).stop = n.stop.bind(n)), n;
		return D.map(c, lt, u), y(u.opts.start) && u.opts.start.call(r, u), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always), D.fx.timer(D.extend(l, {
			elem: r,
			anim: u,
			queue: u.opts.queue
		})), u
	...
	D.Animation = D.extend(ut, {
		...
		tweener: function (e, t) {
			for (var n, i = 0, o = (e = y(e) ? (t = e, ["*"]) : e.match(L)).length; i < o; i++) n = e[i], ut.tweeners[n] = ut.tweeners[n] || [], ut.tweeners[n].unshift(t)
		},
		prefilters: [function (e, t, n) {
			var i, o, r, s, a, l, u, c, h = "width" in t || "height" in t,
				d = this,
				f = {},
				p = e.style,
				m = e.nodeType && oe(e),
				g = X.get(e, "fxshow");
			for (i in n.queue || (null == (s = D._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
					s.unqueued || a()
				...
				} if ((l = !D.isEmptyObject(t)) || !D.isEmptyObject(f))
				for (i in h && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (u = g && g.display) && (u = X.get(e, "display")), "none" === (c = D.css(e, "display")) && (u ? c = u : (le([e], !0), u = e.style.display || u, c = D.css(e, "display"), le([e]))), ("inline" === c || "inline-block" === c && null != u) && "none" === D.css(e, "float") && (l || (d.done(function () {
						p.display = u
					}), null == u && (c = p.display, u = "none" === c ? "" : c)), p.display = "inline-block")), n.overflow && (p.overflow = "hidden", d.always(function () {
						p.overflow = n.overflow[0], p.overflowX = n.overflow[1], p.overflowY = n.overflow[2]
					})), l = !1, f) l || (g ? "hidden" in g && (m = g.hidden) : g = X.access(e, "fxshow", {
					display: u
				}), r && (g.hidden = !m), m && le([e], !0), d.done(function () {
					for (i in m || le([e]), X.remove(e, "fxshow"), f) D.style(e, i, f[i])
		...
		stop: function (o, e, r) {
			...
			return "string" != typeof o && (r = e, e = o, o = void 0), e && !1 !== o && this.queue(o || "fx", []), this.each(function () {
				...
				if (t) i[t] && i[t].stop && s(i[t]);
					...
					for (t in i) i[t] && i[t].stop && ot.test(t) && s(i[t]);
				for (t = n.length; t--;) n[t].elem !== this || null != o && n[t].queue !== o || (n[t].anim.stop(r), e = !1, n.splice(t, 1));
				!e && r || D.dequeue(this, o)
			})
		},
		finish: function (s) {
			return !1 !== s && (s = s || "fx"), this.each(function () {
				var e, t = X.get(this),
					...
					o = D.timers,
					r = n ? n.length : 0;
				for (t.finish = !0, D.queue(this, s, []), i && i.stop && i.stop.call(this, !0), e = o.length; e--;) o[e].elem === this && o[e].queue === s && (o[e].anim.stop(!0), o.splice(e, 1));
		...
		D.fn[i] = function (e, t, n) {
			return null == e || "boolean" == typeof e ? o.apply(this, arguments) : this.animate(at(i, !0), e, t, n)
		}
	}), D.each({
		slideDown: at("show"),
		slideUp: at("hide"),
	...
	var ct, ht = D.expr.attrHandle;
	D.fn.extend({
		attr: function (e, t) {
			return W(this, D.attr, e, t, 1 < arguments.length)
		},
		...
		attr: function (e, t, n) {
			...
			if (3 !== r && 8 !== r && 2 !== r) return void 0 === e.getAttribute ? D.prop(e, t, n) : (1 === r && D.isXMLDoc(e) || (o = D.attrHooks[t.toLowerCase()] || (D.expr.match.bool.test(t) ? ct : void 0)), void 0 !== n ? null === n ? void D.removeAttr(e, t) : o && "set" in o && void 0 !== (i = o.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : o && "get" in o && null !== (i = o.get(e, t)) ? i : null == (i = D.find.attr(e, t)) ? void 0 : i)
		},
		attrHooks: {
			type: {
				set: function (e, t) {
		...
		var s = ht[t] || D.find.attr;
		ht[t] = function (e, t, n) {
			var i, o, r = t.toLowerCase();
			return n || (o = ht[r], ht[r] = i, i = null != s(e, t, n) ? r : null, ht[r] = o), i
		}
	});
	...
	D.fn.extend({
		prop: function (e, t) {
			return W(this, D.prop, e, t, 1 < arguments.length)
		},
		...
		prop: function (e, t, n) {
			var i, o, r = e.nodeType;
			if (3 !== r && 8 !== r && 2 !== r) return 1 === r && D.isXMLDoc(e) || (t = D.propFix[t] || t, o = D.propHooks[t]), void 0 !== n ? o && "set" in o && void 0 !== (i = o.set(e, n, t)) ? i : e[t] = n : o && "get" in o && null !== (i = o.get(e, t)) ? i : e[t]
		},
		propHooks: {
			tabIndex: {
				get: function (e) {
		...
		addClass: function (t) {
			...
			if (y(t)) return this.each(function (e) {
				D(this).addClass(t.call(this, e, mt(this)))
			});
			if ((e = gt(t)).length)
				for (; n = this[l++];)
		...
		removeClass: function (t) {
			var e, n, i, o, r, s, a, l = 0;
			if (y(t)) return this.each(function (e) {
				D(this).removeClass(t.call(this, e, mt(this)))
			});
		...
		toggleClass: function (o, t) {
			...
			return "boolean" == typeof t && s ? t ? this.addClass(o) : this.removeClass(o) : y(o) ? this.each(function (e) {
				D(this).toggleClass(o.call(this, e, mt(this), t), t)
			}) : this.each(function () {
				var e, t, n, i;
				if (s)
					for (t = 0, n = D(this), i = gt(o); e = i[t++];) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
				else void 0 !== o && "boolean" !== r || ((e = mt(this)) && X.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === o ? "" : X.get(this, "__className__") || ""))
			})
		},
		hasClass: function (e) {
			var t, n, i = 0;
	...
	D.fn.extend({
		val: function (n) {
			...
			return arguments.length ? (o = y(n), this.each(function (e) {
				var t;
				1 === this.nodeType && (null == (t = o ? n.call(this, e, D(this).val()) : n) ? t = "" : "number" == typeof t ? t += "" : Array.isArray(t) && (t = D.map(t, function (e) {
					return null == e ? "" : e + ""
				})), (i = D.valHooks[this.type] || D.valHooks[this.nodeName.toLowerCase()]) && "set" in i && void 0 !== i.set(this, t, "value") || (this.value = t))
			})) : t ? (i = D.valHooks[t.type] || D.valHooks[t.nodeName.toLowerCase()]) && "get" in i && void 0 !== (e = i.get(t, "value")) ? e : "string" == typeof (e = t.value) ? e.replace(vt, "") : null == e ? "" : e : void 0
		}
	}), D.extend({
		valHooks: {
			option: {
			...
			select: {
				...
				set: function (e, t) {
					for (var n, i, o = e.options, r = D.makeArray(t), s = o.length; s--;)((i = o[s]).selected = -1 < D.inArray(D.valHooks.option.get(i), r)) && (n = !0);
	...
	D.extend(D.event, {
		trigger: function (e, t, n, i) {
			var o, r, s, a, l, u, c, h, d = [n || S],
				f = g.call(e, "type") ? e.type : e,
				p = g.call(e, "namespace") ? e.namespace.split(".") : [];
			if (r = h = s = n = n || S, 3 !== n.nodeType && 8 !== n.nodeType && !yt.test(f + D.event.triggered) && (-1 < f.indexOf(".") && (f = (p = f.split(".")).shift(), p.sort()), l = f.indexOf(":") < 0 && "on" + f, (e = e[D.expando] ? e : new D.Event(f, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : D.makeArray(t, [e]), c = D.event.special[f] || {}, i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
				if (!i && !c.noBubble && !b(n)) {
					for (a = c.delegateType || f, yt.test(a + f) || (r = r.parentNode); r; r = r.parentNode) d.push(r), s = r;
					s === (n.ownerDocument || S) && d.push(s.defaultView || s.parentWindow || C)
				}
				for (o = 0;
					(r = d[o++]) && !e.isPropagationStopped();) h = r, e.type = 1 < o ? a : c.bindType || f, (u = (X.get(r, "events") || {})[e.type] && X.get(r, "handle")) && u.apply(r, t), (u = l && r[l]) && u.apply && K(r) && (e.result = u.apply(r, t), !1 === e.result && e.preventDefault());
				return e.type = f, i || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(d.pop(), t) || !K(n) || l && y(n[f]) && !b(n) && ((s = n[l]) && (n[l] = null), D.event.triggered = f, e.isPropagationStopped() && h.addEventListener(f, bt), n[f](), e.isPropagationStopped() && h.removeEventListener(f, bt), D.event.triggered = void 0, s && (n[l] = s)), e.result
			}
		},
	...
	function Et(n, e, i, o) {
		...
		if (Array.isArray(e)) D.each(e, function (e, t) {
			i || Ct.test(n) ? o(n, t) : Et(n + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, i, o)
		});
	...
	D.param = function (e, t) {
		...
		serializeArray: function () {
			return this.map(function () {
				...
				var e = this.type;
				return this.name && !D(this).is(":disabled") && xt.test(this.nodeName) && !Dt.test(e) && (this.checked || !ue.test(e))
			}).map(function (e, t) {
				var n = D(this).val();
	...
	function Ut(t, o, r, s) {
		...
		function u(e) {
			var i;
			return a[e] = !0, D.each(t[e] || [], function (e, t) {
				var n = t(o, r, s);
	...
	Pt.href = wt.href, D.extend({
		...
		ajax: function (e, t) {
			...
			var c, h, d, n, f, i, p, m, o, r, g = D.ajaxSetup({}, t),
				v = g.context || g,
				y = g.context && (v.nodeType || v.jquery) ? D(v) : D.event,
				b = D.Deferred(),
				...
				T = {
					...
					getResponseHeader: function (e) {
						...
						if (p) {
							if (!n)
								for (n = {}; t = It.exec(d);) n[t[1].toLowerCase()] = t[2];
							t = n[e.toLowerCase()]
						}
			...
			if (b.promise(T), g.url = ((e || g.url || wt.href) + "").replace(Nt, wt.protocol + "//"), g.type = t.method || t.type || g.method || g.type, g.dataTypes = (g.dataType || "*").toLowerCase().match(L) || [""], null == g.crossDomain) {
				i = S.createElement("a");
				try {
			...
			if (g.data && g.processData && "string" != typeof g.data && (g.data = D.param(g.data, g.traditional)), Ut(Ht, g, t, T), p) return T;
			for (o in (m = D.event && g.global) && 0 == D.active++ && D.event.trigger("ajaxStart"), g.type = g.type.toUpperCase(), g.hasContent = !Ot.test(g.type), h = g.url.replace(At, ""), g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(kt, "+")) : (r = g.url.slice(h.length), g.data && (g.processData || "string" == typeof g.data) && (h += (Tt.test(h) ? "&" : "?") + g.data, delete g.data), !1 === g.cache && (h = h.replace(Mt, "$1"), r = (Tt.test(h) ? "&" : "?") + "_=" + _t++ + r), g.url = h + r), g.ifModified && (D.lastModified[h] && T.setRequestHeader("If-Modified-Since", D.lastModified[h]), D.etag[h] && T.setRequestHeader("If-None-Match", D.etag[h])), (g.data && g.hasContent && !1 !== g.contentType || t.contentType) && T.setRequestHeader("Content-Type", g.contentType), T.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Lt + "; q=0.01" : "") : g.accepts["*"]), g.headers) T.setRequestHeader(o, g.headers[o]);
			if (g.beforeSend && (!1 === g.beforeSend.call(v, T, g) || p)) return T.abort();
			if (l = "abort", w.add(g.complete), T.done(g.success), T.fail(g.error), c = Ut($t, g, t, T)) {
			...
			function u(e, t, n, i) {
				var o, r, s, a, l, u = t;
				p || (p = !0, f && C.clearTimeout(f), c = void 0, d = i || "", T.readyState = 0 < e ? 4 : 0, o = 200 <= e && e < 300 || 304 === e, n && (a = function (e, t, n) {
	...
	}), D.each(["get", "post"], function (e, o) {
		D[o] = function (e, t, n, i) {
	...
	v.cors = !!Rt && "withCredentials" in Rt, v.ajax = Rt = !!Rt, D.ajaxTransport(function (o) {
		var r, s;
	...
	D.ajaxSetup({
		...
		if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Vt, "$1" + i) : !1 !== e.jsonp && (e.url += (Tt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function () {
			return r || D.error(i + " was not called"), r[0]
		}, e.dataTypes[0] = "json", o = C[i], C[i] = function () {
			r = arguments
		}, n.always(function () {
			void 0 === o ? D(C).removeProp(i) : C[i] = o, e[i] && (e.jsonpCallback = t.jsonpCallback, Bt.push(i)), r && y(o) && o(r[0]), r = o = void 0
		}), "script"
	}), v.createHTMLDocument = ((Wt = S.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Wt.childNodes.length), D.parseHTML = function (e, t, n) {
		return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (v.createHTMLDocument ? ((i = (t = S.implementation.createHTMLDocument("")).createElement("base")).href = S.location.href, t.head.appendChild(i)) : t = S), r = !n && [], (o = A.exec(e)) ? [t.createElement(o[1])] : (o = ye([e], t, r), r && r.length && D(r).remove(), D.merge([], o.childNodes)));
		var i, o, r
	}, D.fn.load = function (e, t, n) {
		var i, o, r, s = this,
			a = e.indexOf(" ");
		return -1 < a && (i = pt(e.slice(a)), e = e.slice(0, a)), y(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), 0 < s.length && D.ajax({
			url: e,
			type: o || "GET",
			dataType: "html",
			data: t
		}).done(function (e) {
			r = arguments, s.html(i ? D("<div>").append(D.parseHTML(e)).find(i) : e)
		...
		setOffset: function (e, t, n) {
			var i, o, r, s, a, l, u = D.css(e, "position"),
				c = D(e),
				h = {};
			"static" === u && (e.style.position = "relative"), a = c.offset(), r = D.css(e, "top"), l = D.css(e, "left"), o = ("absolute" === u || "fixed" === u) && -1 < (r + l).indexOf("auto") ? (s = (i = c.position()).top, i.left) : (s = parseFloat(r) || 0, parseFloat(l) || 0), y(t) && (t = t.call(e, n, D.extend({}, a))), null != t.top && (h.top = t.top - a.top + s), null != t.left && (h.left = t.left - a.left + o), "using" in t ? t.using.call(e, h) : c.css(h)
		}
	}, D.fn.extend({
		offset: function (t) {
		...
		position: function () {
			if (this[0]) {
				...
				if ("fixed" === D.css(i, "position")) t = i.getBoundingClientRect();
					...
					e && e !== i && 1 === e.nodeType && ((o = D(e).offset()).top += D.css(e, "borderTopWidth", !0), o.left += D.css(e, "borderLeftWidth", !0))
				}
				return {
					top: t.top - o.top - D.css(i, "marginTop", !0),
					left: t.left - o.left - D.css(i, "marginLeft", !0)
				}
			}
		},
		...
		D.cssHooks[n] = qe(v.pixelPosition, function (e, t) {
			if (t) return t = Fe(e, n), Pe.test(t) ? D(e).position()[n] + "px" : t
		})
	}), D.each({
		Height: "height",
		Width: "width"
		...
		D.each({
			...
			D.fn[r] = function (e, t) {
				...
				return W(this, function (e, t, n) {
					var i;
					return b(e) ? 0 === r.indexOf("outer") ? e["inner" + s] : e.document.documentElement["client" + s] : 9 === e.nodeType ? (i = e.documentElement, Math.max(e.body["scroll" + s], i["scroll" + s], e.body["offset" + s], i["offset" + s], i["client" + s])) : void 0 === n ? D.css(e, t, o) : D.style(e, t, n, o)
				}, a, n ? e : void 0, n)
			}
		})
		...
		}).guid = e.guid = e.guid || D.guid++, o
	}, D.holdReady = function (e) {
		e ? D.readyWait++ : D.ready(!0)
	}, D.isArray = Array.isArray, D.parseJSON = JSON.parse, D.nodeName = k, D.isFunction = y, D.isWindow = b, D.camelCase = Y, D.type = _, D.now = Date.now, D.isNumeric = function (e) {
		var t = D.type(e);
	...
	return D.noConflict = function (e) {
		return C.$ === D && (C.$ = Yt), e && C.jQuery === D && (C.jQuery = zt), D
	}, e || (C.jQuery = C.$ = D), D
}),
function (e, t) {
	...
	p(document).on(c.CLICK_DATA_API, '[data-dismiss="alert"]', g._handleDismiss(new g)), p.fn[o] = g._jQueryInterface, p.fn[o].Constructor = g, p.fn[o].noConflict = function () {
		return p.fn[o] = u, g._jQueryInterface
	};
	var v = "button",
		y = "bs.button",
		b = "." + y,
	...
	p(document).on(M.CLICK_DATA_API, D, function (e) {
		e.preventDefault();
		var t = e.target;
		p(t).hasClass(C) || (t = p(t).closest(A)), I._jQueryInterface.call(p(t), "toggle")
	}).on(M.FOCUS_BLUR_DATA_API, D, function (e) {
		var t = p(e.target).closest(A)[0];
		p(t).toggleClass(S, /^focus(in)?$/.test(e.type))
	}), p.fn[v] = I._jQueryInterface, p.fn[v].Constructor = I, p.fn[v].noConflict = function () {
		return p.fn[v] = _, I._jQueryInterface
	};
	var O = "carousel",
		N = "bs.carousel",
		H = "." + N,
		...
		ae = function () {
			...
			return e.next = function () {
				...
				p(this._element).off(H), p.removeData(this._element, N), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
			}, e._getConfig = function (e) {
				return e = l({}, P, e), m.typeCheckConfig(O, e, j), e
				...
				var t = this;
				this._config.keyboard && p(this._element).on(W.KEYDOWN, function (e) {
					return t._keydown(e)
				}), "hover" === this._config.pause && p(this._element).on(W.MOUSEENTER, function (e) {
					return t.pause(e)
				...
				if (this._touchSupported) {
					...
					p(this._element.querySelectorAll(te)).on(W.DRAG_START, function (e) {
						return e.preventDefault()
					}), this._pointerEvent ? (p(this._element).on(W.POINTERDOWN, function (e) {
						return t(e)
					}), p(this._element).on(W.POINTERUP, function (e) {
						return i(e)
					}), this._element.classList.add(Z)) : (p(this._element).on(W.TOUCHSTART, function (e) {
						return t(e)
					}), p(this._element).on(W.TOUCHMOVE, function (e) {
						var t;
					...
					}), p(this._element).on(W.TOUCHEND, function (e) {
						return i(e)
					}))
				}
				...
				if (o = e === U ? (n = K, i = Q, q) : (n = Y, i = X, R), l && p(l).hasClass(V)) this._isSliding = !1;
				else if (!this._triggerSlideEvent(l, o).isDefaultPrevented() && s && l) {
					this._isSliding = !0, c && this.pause(), this._setActiveIndicatorElement(l);
					var h = p.Event(W.SLID, {
						relatedTarget: l,
						direction: o,
						from: a,
						to: u
					...
					if (p(this._element).hasClass(z)) {
						...
						p(s).one(m.TRANSITION_END, function () {
							p(l).removeClass(n + " " + i).addClass(V), p(s).removeClass(V + " " + i + " " + n), r._isSliding = !1, setTimeout(function () {
								return p(r._element).trigger(h)
							}, 0)
						}).emulateTransitionEnd(f)
					} else p(s).removeClass(V), p(l).addClass(V), this._isSliding = !1, p(this._element).trigger(h);
					c && this.cycle()
				}
				...
				return this.each(function () {
					...
					if (e || (e = new r(this, t), p(this).data(N, e)), "number" == typeof i) e.to(i);
				...
				if (t) {
					...
					if (n && p(n).hasClass(B)) {
						...
						o && (i.interval = !1), r._jQueryInterface.call(p(n), i), o && p(n).data(N).to(o), e.preventDefault()
					}
				}
			}, s(r, null, [{
				key: "VERSION",
	...
	p(document).on(W.CLICK_DATA_API, oe, ae._dataApiClickHandler), p(window).on(W.LOAD_DATA_API, function () {
		...
		return p.fn[O] = L, ae._jQueryInterface
	};
	var le = "collapse",
		ue = "bs.collapse",
		ce = "." + ue,
		...
		Ce = function () {
			...
			return e.toggle = function () {
				...
				var e, t, n = this;
				if (!this._isTransitioning && !p(this._element).hasClass(me) && (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(_e)).filter(function (e) {
					...
					if (p(this._element).trigger(i), !i.isDefaultPrevented()) {
						...
						p(this._element).removeClass(ge).addClass(ve), this._element.style[o] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(ye).attr("aria-expanded", !0), this.setTransitioning(!0);
						...
						if (0 < i)
							for (var o = 0; o < i; o++) {
								var r = this._triggerArray[o],
									s = m.getSelectorFromElement(r);
								if (null !== s) p([].slice.call(document.querySelectorAll(s))).hasClass(me) || p(r).addClass(ye).attr("aria-expanded", !1)
							}
				...
				return (e = l({}, de, e)).toggle = Boolean(e.toggle), m.typeCheckConfig(le, e, fe), e
	...
	p(document).on(pe.CLICK_DATA_API, Te, function (e) {
	...
	for (var Se = "undefined" != typeof window && "undefined" != typeof document, De = ["Edge", "Trident", "Firefox"], xe = 0, Ee = 0; Ee < De.length; Ee += 1)
		if (Se && 0 <= navigator.userAgent.indexOf(De[Ee])) {
			xe = 1;
			break
		} var ke = Se && window.Promise ? function (e) {
		var t = !1;
		return function () {
	...
	function Oe(e) {
		...
		var t = Me(e),
			...
			i = t.overflowX,
			o = t.overflowY;
		return /(auto|scroll|overlay)/.test(n + o + i) ? e : Oe(Ie(e))
	}
	var Ne = Se && !(!window.MSInputMethodContext || !document.documentMode),
		He = Se && /MSIE 10/.test(navigator.userAgent);

	function $e(e) {
		return 11 === e ? Ne : 10 === e ? He : Ne || He
	}
	...
	function Le(e) {
		...
		var i = n && n.nodeName;
		return i && "BODY" !== i && "HTML" !== i ? -1 !== ["TH", "TD", "TABLE"].indexOf(n.nodeName) && "static" === Me(n, "position") ? Le(n) : n : e ? e.ownerDocument.documentElement : document.documentElement
	}
	...
	function je(e, t) {
		...
		if (e !== l && t !== l || i.contains(o)) return "BODY" === (a = (s = l).nodeName) || "HTML" !== a && Le(s.firstElementChild) !== s ? Le(l) : l;
		var u = Pe(e);
		return u.host ? je(u.host, t) : je(e, Pe(t).host)
	}
	...
	function qe(e, t, n, i) {
		return Math.max(t["offset" + e], t["scroll" + e], n["client" + e], n["offset" + e], n["scroll" + e], $e(10) ? parseInt(n["offset" + e]) + parseInt(i["margin" + ("Height" === e ? "Top" : "Left")]) + parseInt(i["margin" + ("Height" === e ? "Bottom" : "Right")]) : 0)
	}

	function Re(e) {
		var t = e.body,
			n = e.documentElement,
			i = $e(10) && getComputedStyle(n);
		return {
	...
	function Ye(e) {
		...
		var o = {
			...
			r = "HTML" === e.nodeName ? Re(e.ownerDocument) : {},
		...
		if (l || u) {
			var c = Me(e);
			l -= Fe(c, "x"), u -= Fe(c, "y"), o.width -= l, o.height -= u
		}
		return ze(o)
	}
		...
		if ("viewport" === i) r = function (e) {
			...
			if ("HTML" !== a.nodeName || function e(t) {
				...
				var u = Re(e.ownerDocument),
					c = u.height,
					h = u.width;
				r.top += l.top - l.marginTop, r.bottom = c + l.top, r.left += l.left - l.marginLeft, r.right = h + l.left
			}
		}
	...
	function tt(e, t, n) {
		...
		var i = Je(e),
			...
			l = r ? "height" : "width",
			u = r ? "width" : "height";
		return o[s] = t[s] + t[l] / 2 - i[l] / 2, o[a] = n === a ? t[a] - i[u] : t[et(a)], o
	}
	...
	function it(e, n, t) {
		return (void 0 === t ? e : e.slice(0, function (e, t, n) {
			...
			e.enabled && Ae(t) && (n.offsets.popper = ze(n.offsets.popper), n.offsets.reference = ze(n.offsets.reference), n = t(n, e))
		}), n
	}
	...
	function at(e, t, n, i) {
		...
		return function e(t, n, i, o) {
			...
			s.addEventListener(n, i, {
				passive: !0
			}), r || e(Oe(s.parentNode), n, i, o), o.push(s)
	...
	var ht = Se && /Firefox/i.test(navigator.userAgent);
	...
	var wt = {
			...
			modifiers: {
				...
				offset: {
					...
					fn: function (e, t) {
						var n = t.offset,
							...
							a = i.split("-")[0],
							l = void 0;
						return l = ut(+n) ? [+n, 0] : bt(n, r, s, a), "left" === a ? (r.top += l[0], r.left -= l[1]) : "right" === a ? (r.top += l[0], r.left += l[1]) : "top" === a ? (r.left += l[0], r.top -= l[1]) : "bottom" === a && (r.left += l[0], r.top += l[1]), e.popper = r, e
					},
					offset: 0
				},
				preventOverflow: {
					...
					fn: function (e, i) {
						...
						var u = i.priority,
							...
							h = {
								primary: function (e) {
									var t = c[e];
									return c[e] < l[e] && !i.escapeWithReference && (t = Math.max(c[e], l[e])), Be({}, e, t)
								},
								secondary: function (e) {
									var t = "right" === e ? "left" : "top",
										n = c[t];
									return c[e] > l[e] && !i.escapeWithReference && (n = Math.min(c[t], l[e] - ("right" === e ? c.width : c.height))), Be({}, t, n)
								}
							};
				...
				keepTogether: {
					...
					fn: function (e) {
						var t = e.offsets,
							...
							l = s ? "left" : "top",
							u = s ? "width" : "height";
						return n[a] < r(i[l]) && (e.offsets.popper[l] = r(i[l]) - n[u]), n[l] > r(i[a]) && (e.offsets.popper[l] = r(i[a])), e
					}
				},
				arrow: {
					order: 500,
					...
					fn: function (e, t) {
						...
						var o = e.placement.split("-")[0],
							...
							f = l ? "bottom" : "right",
							p = Je(i)[u];
						a[f] - p < s[h] && (e.offsets.popper[h] -= s[h] - (a[f] - p)), a[h] + p > s[f] && (e.offsets.popper[h] += a[h] + p - s[f]), e.offsets.popper = ze(e.offsets.popper);
						var m = a[h] + a[u] / 2 - p / 2,
							g = Me(e.instance.popper),
							v = parseFloat(g["margin" + c], 10),
							y = parseFloat(g["border" + c + "Width"], 10),
							b = m - e.offsets.popper[h] - v - y;
						return b = Math.max(Math.min(s[u] - p, b), 0), e.arrowElement = i, e.offsets.arrow = (Be(n = {}, h, Math.round(b)), Be(n, d, ""), n), e
					},
					element: "[x-arrow]"
				},
				flip: {
					...
					fn: function (p, m) {
						...
						return w.forEach(function (e, t) {
							...
							var n, i = p.offsets.popper,
								...
								u = r(i.top) < r(g.top),
								c = r(i.bottom) > r(g.bottom),
								h = "left" === v && a || "right" === v && l || "top" === v && u || "bottom" === v && c,
								d = -1 !== ["top", "bottom"].indexOf(v),
								f = !!m.flipVariations && (d && "start" === b && a || d && "end" === b && l || !d && "start" === b && u || !d && "end" === b && c);
							(s || h || f) && (p.flipped = !0, (s || h) && (v = w[t + 1]), f && (b = "end" === (n = b) ? "start" : "start" === n ? "end" : n), p.placement = v + (b ? "-" + b : ""), p.offsets.popper = Ve({}, p.offsets.popper, tt(p.instance.popper, p.offsets.reference, p.placement)), p = it(p.instance.modifiers, p, "flip"))
						}), p
					},
					behavior: "flip",
					padding: 5,
				...
				inner: {
					...
					fn: function (e) {
						...
						return o[s ? "left" : "top"] = r[n] - (a ? o[s ? "width" : "height"] : 0), e.placement = et(t), e.offsets.popper = ze(o), e
					}
				},
				hide: {
					order: 800,
				...
				computeStyle: {
					...
					fn: function (e, t) {
						...
						var s, a, l, u, c, h, d, f, p, m, g, v, y, b, w = void 0 !== r ? r : t.gpuAcceleration,
							_ = Le(e.instance.popper),
							T = Ye(_),
							C = {
								position: o.position
							},
							S = (s = e, a = window.devicePixelRatio < 2 || !ht, l = s.offsets, u = l.popper, c = l.reference, h = Math.round, d = Math.floor, f = function (e) {
								return e
							}, p = h(c.width), m = h(u.width), g = -1 !== ["left", "right"].indexOf(s.placement), v = -1 !== s.placement.indexOf("-"), b = a ? h : f, {
								left: (y = a ? g || v || p % 2 == m % 2 ? h : d : f)(p % 2 == 1 && m % 2 == 1 && !v && a ? u.left - 1 : u.left),
								top: b(u.top),
								bottom: b(u.bottom),
								right: y(u.right)
							}),
							D = "bottom" === n ? "top" : "bottom",
							x = "right" === i ? "left" : "right",
							E = rt("transform"),
							k = void 0,
							A = void 0;
						if (A = "bottom" === D ? "HTML" === _.nodeName ? -_.clientHeight + S.bottom : -T.height + S.bottom : S.top, k = "right" === x ? "HTML" === _.nodeName ? -_.clientWidth + S.right : -T.width + S.right : S.left, w && E) C[E] = "translate3d(" + k + "px, " + A + "px, 0)", C[D] = 0, C[x] = 0, C.willChange = "transform";
						else {
							var M = "bottom" === D ? -1 : 1,
								I = "right" === x ? -1 : 1;
							C[D] = A * M, C[x] = k * I, C.willChange = D + ", " + x
						}
						var O = {
							"x-placement": e.placement
						};
						return e.attributes = Ve({}, O, e.attributes), e.styles = Ve({}, C, e.styles), e.arrowStyles = Ve({}, e.offsets.arrow, e.arrowStyles), e
					},
					gpuAcceleration: !0,
					x: "bottom",
					y: "right"
				...
				applyStyle: {
					...
					onLoad: function (e, t, n, i, o) {
						var r = Ge(o, t, e, n.positionFixed),
							s = Ze(n.placement, r, t, e, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
		...
		_t = function () {
			function r(e, t) {
				...
				}, this.update = ke(this.update.bind(this)), this.options = Ve({}, r.Defaults, i), this.state = {
					isDestroyed: !1,
					isCreated: !1,
					scrollParents: []
				}, this.reference = e && e.jquery ? e[0] : e, this.popper = t && t.jquery ? t[0] : t, this.options.modifiers = {}, Object.keys(Ve({}, r.Defaults.modifiers, i.modifiers)).forEach(function (e) {
					n.options.modifiers[e] = Ve({}, r.Defaults.modifiers[e] || {}, i.modifiers ? i.modifiers[e] : {})
				...
				value: function () {
					return function () {
						if (!this.state.isDestroyed) {
							...
							e.offsets.reference = Ge(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = Ze(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = tt(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = it(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
						}
					}.call(this)
				}
			}, {
	...
	_t.Utils = ("undefined" != typeof window ? window : global).PopperUtils, _t.placements = ft, _t.Defaults = wt;
	var Tt = "dropdown",
		Ct = "bs.dropdown",
		St = "." + Ct,
		Dt = ".data-api",
		...
		kt = {
			...
			SHOWN: "shown" + St,
			CLICK: "click" + St,
			CLICK_DATA_API: "click" + St + Dt,
			KEYDOWN_DATA_API: "keydown" + St + Dt,
			KEYUP_DATA_API: "keyup" + St + Dt
		},
		At = "disabled",
		Mt = "show",
		It = "dropup",
		...
		jt = ".dropdown-menu",
		Ut = ".navbar-nav",
		Ft = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)",
		qt = "top-start",
		Rt = "top-end",
		Wt = "bottom-start",
		Bt = "bottom-end",
		...
		Qt = function () {
			...
			return e.toggle = function () {
					...
					if (u._clearMenus(), !t) {
						...
						if (p(e).trigger(i), !i.isDefaultPrevented()) {
							if (!this._inNavbar) {
								...
								var o = this._element;
								"parent" === this._config.reference ? o = e : m.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(e).addClass($t), this._popper = new _t(o, this._menu, this._getPopperConfig())
							}
							"ontouchstart" in document.documentElement && 0 === p(e).closest(Ut).length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(Mt), p(e).toggleClass(Mt).trigger(p.Event(kt.SHOWN, n))
						}
					}
				}
			}, e.show = function () {
				if (!(this._element.disabled || p(this._element).hasClass(At) || p(this._menu).hasClass(Mt))) {
					var e = {
							relatedTarget: this._element
						},
						t = p.Event(kt.SHOW, e),
						n = u._getParentFromElement(this._element);
					p(n).trigger(t), t.isDefaultPrevented() || (p(this._menu).toggleClass(Mt), p(n).toggleClass(Mt).trigger(p.Event(kt.SHOWN, e)))
				}
			}, e.hide = function () {
				if (!this._element.disabled && !p(this._element).hasClass(At) && p(this._menu).hasClass(Mt)) {
					var e = {
						...
						t = p.Event(kt.HIDE, e),
						n = u._getParentFromElement(this._element);
					p(n).trigger(t), t.isDefaultPrevented() || (p(this._menu).toggleClass(Mt), p(n).toggleClass(Mt).trigger(p.Event(kt.HIDDEN, e)))
				}
			}, e.dispose = function () {
				...
				var t = this;
				p(this._element).on(kt.CLICK, function (e) {
					e.preventDefault(), e.stopPropagation(), t.toggle()
				})
			}, e._getConfig = function (e) {
				return e = l({}, this.constructor.Default, p(this._element).data(), e), m.typeCheckConfig(Tt, e, this.constructor.DefaultType), e
				...
				var e = p(this._element.parentNode),
					t = Wt;
				return e.hasClass(It) ? (t = qt, p(this._menu).hasClass(Ht) && (t = Rt)) : e.hasClass(Ot) ? t = Vt : e.hasClass(Nt) ? t = zt : p(this._menu).hasClass(Ht) && (t = Bt), t
				...
				if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
					for (var t = [].slice.call(document.querySelectorAll(Lt)), n = 0, i = t.length; n < i; n++) {
						...
						if (e && "click" === e.type && (s.clickEvent = e), r) {
							var a = r._menu;
							if (p(o).hasClass(Mt) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && p.contains(o, e.target))) {
								var l = p.Event(kt.HIDE, s);
								p(o).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), t[n].setAttribute("aria-expanded", "false"), p(a).removeClass(Mt), p(o).removeClass(Mt).trigger(p.Event(kt.HIDDEN, s)))
							}
						}
					}
				...
				if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || p(e.target).closest(jt).length)) : Et.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !p(this).hasClass(At))) {
	...
	p(document).on(kt.KEYDOWN_DATA_API, Lt, Qt._dataApiKeydownHandler).on(kt.KEYDOWN_DATA_API, jt, Qt._dataApiKeydownHandler).on(kt.CLICK_DATA_API + " " + kt.KEYUP_DATA_API, Qt._clearMenus).on(kt.CLICK_DATA_API, Lt, function (e) {
		e.preventDefault(), e.stopPropagation(), Qt._jQueryInterface.call(p(this), "toggle")
	}).on(kt.CLICK_DATA_API, Pt, function (e) {
		e.stopPropagation()
	}), p.fn[Tt] = Qt._jQueryInterface, p.fn[Tt].Constructor = Qt, p.fn[Tt].noConflict = function () {
		return p.fn[Tt] = xt, Qt._jQueryInterface
	};
	var Xt = "modal",
		Zt = "bs.modal",
		Gt = "." + Zt,
		...
		gn = function () {
			...
			return e.toggle = function (e) {
				...
				[window, this._element, this._dialog].forEach(function (e) {
					return p(e).off(Gt)
				}), p(document).off(nn.FOCUSIN), p.removeData(this._element, Zt), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
				...
				this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), p(this._dialog).hasClass(on) ? this._dialog.querySelector(hn).scrollTop = 0 : this._element.scrollTop = 0, n && m.reflow(this._element), p(this._element).addClass(un), this._config.focus && this._enforceFocus();
				...
				return this.each(function () {
					...
					if (e || (e = new o(this, t), p(this).data(Zt, e)), "string" == typeof n) {
						if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
						e[n](i)
	...
	p(document).on(nn.CLICK_DATA_API, dn, function (e) {
		...
		var o = p(t).data(Zt) ? "toggle" : l({}, p(t).data(), p(this).data());
	...
	}), p.fn[Xt] = gn._jQueryInterface, p.fn[Xt].Constructor = gn, p.fn[Xt].noConflict = function () {
		return p.fn[Xt] = Jt, gn._jQueryInterface
	};
			...
			return e.enable = function () {
				...
				if (this._isEnabled)
					if (e) {
						...
						if (p(this.getTipElement()).hasClass(Ln)) return void this._leave(null, this);
				...
				if (this.isWithContent() && this._isEnabled) {
					...
					o.setAttribute("id", r), this.element.setAttribute("aria-describedby", r), this.setContent(), this.config.animation && p(o).addClass($n);
					var s = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
						a = this._getAttachment(s);
					this.addAttachmentClass(a);
					var l = this._getContainer();
					p(o).data(this.constructor.DATA_KEY, this), p.contains(this.element.ownerDocument.documentElement, this.tip) || p(o).appendTo(l), p(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new _t(this.element, o, {
						placement: a,
						modifiers: {
							offset: this._getOffset(),
							flip: {
					...
					}), p(o).addClass(Ln), "ontouchstart" in document.documentElement && p(document.body).children().on("mouseover", null, p.noop);
					var u = function () {
						t.config.animation && t._fixTransition();
						var e = t._hoverState;
						t._hoverState = null, p(t.element).trigger(t.constructor.Event.SHOWN), e === Nn && t._leave(null, t)
					};
					if (p(this.tip).hasClass($n)) {
				...
				if (p(this.element).trigger(i), !i.isDefaultPrevented()) {
					if (p(n).removeClass(Ln), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger[qn] = !1, this._activeTrigger[Fn] = !1, this._activeTrigger[Un] = !1, p(this.tip).hasClass($n)) {
				...
				p(this.getTipElement()).addClass(xn + "-" + e)
			}, e.getTipElement = function () {
				return this.tip = this.tip || p(this.config.template)[0], this.tip
			}, e.setContent = function () {
				var e = this.getTipElement();
				this.setElementContent(p(e.querySelectorAll(Pn)), this.getTitle()), p(e).removeClass($n + " " + Ln)
			}, e.setElementContent = function (e, t) {
				"object" != typeof t || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = _n(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t)) : e.text(t) : this.config.html ? p(t).parent().is(e) || e.empty().append(t) : e.text(p(t).text())
			}, e.getTitle = function () {
				...
				this.config.trigger.split(" ").forEach(function (e) {
					if ("click" === e) p(i.element).on(i.constructor.Event.CLICK, i.config.selector, function (e) {
						...
						var t = e === Un ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN,
							n = e === Un ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT;
				...
				var n = this.constructor.DATA_KEY;
				(t = t || p(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusout" === e.type ? Fn : Un] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = Nn, t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function () {
				...
				return Object.keys(t).forEach(function (e) {
					...
					show: e.delay,
					hide: e.delay
				}), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), m.typeCheckConfig(Tn, e, this.constructor.DefaultType), e.sanitize && (e.template = _n(e.template, e.whiteList, e.sanitizeFn)), e
				...
				null === e.getAttribute("x-placement") && (p(e).removeClass($n), this.config.animation = !1, this.hide(), this.show(), this.config.animation = t)
			}, i._jQueryInterface = function (n) {
				return this.each(function () {
	...
	p.fn[Tn] = Wn._jQueryInterface, p.fn[Tn].Constructor = Wn, p.fn[Tn].noConflict = function () {
		return p.fn[Tn] = Dn, Wn._jQueryInterface
	};
	var Bn = "popover",
		Vn = "bs.popover",
		zn = "." + Vn,
		...
		ii = function (e) {
			...
			return o.isWithContent = function () {
				...
				p(this.getTipElement()).addClass(Kn + "-" + e)
				...
				"function" == typeof t && (t = t.call(this.element)), this.setElementContent(e.find(ti), t), e.removeClass(Gn + " " + Jn)
	...
	p.fn[Bn] = ii._jQueryInterface, p.fn[Bn].Constructor = ii, p.fn[Bn].noConflict = function () {
		return p.fn[Bn] = Yn, ii._jQueryInterface
	};
	var oi = "scrollspy",
		ri = "bs.scrollspy",
		si = "." + ri,
		...
		Ci = function () {
			...
			return e.refresh = function () {
				var t = this,
					e = this._scrollElement === this._scrollElement.window ? _i : Ti,
				...
				return m.typeCheckConfig(oi, e, ui), e
				...
				n.hasClass(hi) ? (n.closest(yi).find(wi).addClass(di), n.addClass(di)) : (n.addClass(di), n.parents(pi).prev(mi + ", " + vi).addClass(di), n.parents(pi).prev(gi).children(mi).addClass(di)), p(this._scrollElement).trigger(ci.ACTIVATE, {
					relatedTarget: t
				})
			}, e._clear = function () {
				...
				return this.each(function () {
					...
					if (e || (e = new n(this, "object" == typeof t && t), p(this).data(ri, e)), "string" == typeof t) {
						if (void 0 === e[t]) throw new TypeError('No method named "' + t + '"');
						e[t]()
					}
				})
	...
	var Si = "bs.tab",
		...
		Fi = function () {
			...
			return e.show = function () {
				var n = this;
				if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Ai) || p(this._element).hasClass(Mi))) {
					var e, i, t = p(this._element).closest(Hi)[0],
						o = m.getSelectorFromElement(this._element);
					if (t) {
						var r = "UL" === t.nodeName || "OL" === t.nodeName ? Li : $i;
						i = (i = p.makeArray(p(t).find(r)))[i.length - 1]
					}
					var s = p.Event(Ei.HIDE, {
							relatedTarget: this._element
						}),
						a = p.Event(Ei.SHOW, {
							relatedTarget: i
				...
				var i = this,
					o = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? p(t).children($i) : p(t).find(Li))[0],
					r = n && o && p(o).hasClass(Ii),
					s = function () {
						return i._transitionComplete(e, o, n)
					};
				if (o && r) {
					var a = m.getTransitionDurationFromElement(o);
					p(o).removeClass(Oi).one(m.TRANSITION_END, s).emulateTransitionEnd(a)
				} else s()
			}, e._transitionComplete = function (e, t, n) {
				if (t) {
					p(t).removeClass(Ai);
					var i = p(t.parentNode).find(Ui)[0];
					i && p(i).removeClass(Ai), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)
				}
				if (p(e).addClass(Ai), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), m.reflow(e), e.classList.contains(Ii) && e.classList.add(Oi), e.parentNode && p(e.parentNode).hasClass(ki)) {
					var o = p(e).closest(Ni)[0];
					if (o) {
						var r = [].slice.call(o.querySelectorAll(ji));
						p(r).addClass(Ai)
					}
	...
	p(document).on(Ei.CLICK_DATA_API, Pi, function (e) {
		...
		return p.fn.tab = xi, Fi._jQueryInterface
	};
	var qi = "toast",
		Ri = "bs.toast",
		Wi = "." + Ri,
		Bi = p.fn[qi],
		Vi = {
			CLICK_DISMISS: "click.dismiss" + Wi,
			HIDE: "hide" + Wi,
			HIDDEN: "hidden" + Wi,
			SHOW: "show" + Wi,
			SHOWN: "shown" + Wi
		...
		Ji = function () {
			...
			return e.show = function () {
				var e = this;
				p(this._element).trigger(Vi.SHOW), this._config.animation && this._element.classList.add(zi);
				var t = function () {
					e._element.classList.remove(Qi), e._element.classList.add(Ki), p(e._element).trigger(Vi.SHOWN), e._config.autohide && e.hide()
				};
				if (this._element.classList.remove(Yi), this._element.classList.add(Qi), this._config.animation) {
					var n = m.getTransitionDurationFromElement(this._element);
					p(this._element).one(m.TRANSITION_END, t).emulateTransitionEnd(n)
				} else t()
			}, e.hide = function (e) {
				var t = this;
				this._element.classList.contains(Ki) && (p(this._element).trigger(Vi.HIDE), e ? this._close() : this._timeout = setTimeout(function () {
					t._close()
				}, this._config.delay))
			}, e.dispose = function () {
				clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Ki) && this._element.classList.remove(Ki), p(this._element).off(Vi.CLICK_DISMISS), p.removeData(this._element, Ri), this._element = null, this._config = null
			}, e._getConfig = function (e) {
				return e = l({}, Zi, p(this._element).data(), "object" == typeof e && e ? e : {}), m.typeCheckConfig(qi, e, this.constructor.DefaultType), e
			}, e._setListeners = function () {
				var e = this;
				p(this._element).on(Vi.CLICK_DISMISS, Gi, function () {
					return e.hide(!0)
				})
			}, e._close = function () {
				var e = this,
	...
	p.fn[qi] = Ji._jQueryInterface, p.fn[qi].Constructor = Ji, p.fn[qi].noConflict = function () {
			return p.fn[qi] = Bi, Ji._jQueryInterface
		},
		function () {
			if (void 0 === p) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
			var e = p.fn.jquery.split(" ")[0].split(".");
			if (e[0] < 2 && e[1] < 9 || 1 === e[0] && 9 === e[1] && e[2] < 1 || 4 <= e[0]) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
		}(), e.Util = m, e.Alert = g, e.Button = I, e.Carousel = ae, e.Collapse = Ce, e.Dropdown = Qt, e.Modal = gn, e.Popover = ii, e.Scrollspy = Ci, e.Tab = Fi, e.Toast = Ji, e.Tooltip = Wn, Object.defineProperty(e, "__esModule", {
			value: !0
		})
}),
function (e) {
	...
	e.prototype = {
		...
		open: function (e) {
			...
			if (!h.isOpen) {
				h.types = [], f = "", e.mainEl && e.mainEl.length ? h.ev = e.mainEl.eq(0) : h.ev = d, e.key ? (h.popupsCache[e.key] || (h.popupsCache[e.key] = {}), h.currTemplate = h.popupsCache[e.key]) : h.currTemplate = {}, h.st = c.extend(!0, {}, c.magnificPopup.defaults, e), h.fixedContentPos = "auto" === h.st.fixedContentPos ? !h.probablyMobile : h.st.fixedContentPos, h.st.modal && (h.st.closeOnContentClick = !1, h.st.closeOnBgClick = !1, h.st.showCloseBtn = !1, h.st.enableEscapeKey = !1), h.bgOverlay || (h.bgOverlay = w("bg").on("click" + g, function () {
					h.close()
				}), h.wrap = w("wrap").attr("tabindex", -1).on("click" + g, function (e) {
				...
				_("BeforeOpen"), h.st.showCloseBtn && (h.st.closeBtnInside ? (b(p, function (e, t, n, i) {
					n.close_replaceWith = T(i.type)
				}), f += " mfp-close-btn-in") : h.wrap.append(T())), h.st.alignTop && (f += " mfp-align-top"), h.fixedContentPos ? h.wrap.css({
					...
					height: d.height(),
					position: "absolute"
				}), h.st.enableEscapeKey && d.on("keyup" + g, function (e) {
				...
				return h.isIE7 && (u += " mfp-ie7"), u && h._addClassToMFP(u), h.updateItemHTML(), _("BuildControls"), c("html").css(a), h.bgOverlay.add(h.wrap).prependTo(h.st.prependTo || c(document.body)), h._lastFocusedEl = document.activeElement, setTimeout(function () {
					h.content ? (h._addClassToMFP(v), h._setFocus()) : h.bgOverlay.addClass(v), d.on("focusin" + g, h._onFocusIn)
				}, 16), h.isOpen = !0, h.updateSize(s), _(m), e
			}
			h.updateItemHTML()
		},
		close: function () {
			h.isOpen && (_(u), h.isOpen = !1, h.st.removalDelay && !h.isLowIE && h.supportsTransition ? (h._addClassToMFP(n), setTimeout(function () {
				h._close()
		...
		updateItemHTML: function () {
			...
			if (_("BeforeChange", [h.currItem ? h.currItem.type : "", t]), h.currItem = e, !h.currTemplate[t]) {
				var n = !!h.st[t] && h.st[t].markup;
				_("FirstMarkupParse", n), h.currTemplate[t] = !n || c(n)
			}
			o && o !== e.type && h.container.removeClass("mfp-" + o + "-holder");
			var i = h["get" + t.charAt(0).toUpperCase() + t.slice(1)](e, h.currTemplate[t]);
			h.appendContent(i, t), e.preloaded = !0, _("Change", e), o = e.type, h.container.prepend(h.contentContainer), _("AfterChange")
		},
		...
		parseEl: function (e) {
			...
			return n.type = t || h.st.type || "inline", n.index = e, n.parsed = !0, h.items[e] = n, _("ElementParse", n), h.items[e]
		},
		...
		updateStatus: function (e, t) {
			if (h.preloader) {
				i !== e && h.container.removeClass("mfp-s-" + i), t || "loading" !== e || (t = h.st.tLoading);
				var n = {
					status: e,
					text: t
				};
				_("UpdateStatus", n), e = n.status, t = n.text, h.preloader.html(t), h.preloader.find("a").on("click", function (e) {
		...
		_hasScrollBar: function (e) {
			return (h.isIE7 ? d.height() : document.body.scrollHeight) > (e || y.height())
		},
		_setFocus: function () {
		...
		_parseMarkup: function (o, e, t) {
			var r;
			t.data && (e = c.extend(t.data, e)), _(p, [o, e, t]), c.each(e, function (e, t) {
				if (void 0 === t || !1 === t) return !0;
				if (1 < (r = e.split("_")).length) {
					var n = o.find(g + "-" + r[0]);
					if (0 < n.length) {
						var i = r[1];
						"replaceWith" === i ? n[0] !== t[0] && n.replaceWith(t) : "img" === i ? n.is("img") ? n.attr("src", t) : n.replaceWith(c("<img>").attr("src", t).attr("class", n.attr("class"))) : n.attr(r[1], t)
					}
		...
		if ("string" == typeof e)
			if ("open" === e) {
				...
				n = i.items ? i.items[o] : (n = t, i.delegate && (n = n.find(i.delegate)), n.eq(o)), h._openClick({
					mfpEl: n
				}, t, i)
	...
	var C, S, D, x = "inline",
		E = function () {
			D && (S.after(D.addClass(C)).detach(), D = null)
		};
			...
			getInline: function (e, t) {
				if (E(), e.src) {
					...
					if (i.length) {
						...
						o && o.tagName && (S || (C = n.hiddenClass, S = w(C), C = "mfp-" + C), D = i.after(S).detach().removeClass(C)), h.updateStatus("ready")
	...
	c.magnificPopup.registerModule(A, {
		...
		proto: {
			initAjax: function () {
				h.types.push(A), k = h.st.ajax.cursor, b(l + "." + A, I), b("BeforeChange." + A, I)
			},
			getAjax: function (o) {
				...
				var e = c.extend({
					...
					success: function (e, t, n) {
						...
						_("ParseAjax", i), h.appendContent(c(i.data), A), o.finished = !0, M(), h._setFocus(), setTimeout(function () {
							h.wrap.addClass(v)
						}, 16), h.updateStatus("ready"), _("AjaxContentAdded")
					},
					error: function () {
						M(), o.finished = o.loadError = !0, h.updateStatus("error", h.st.ajax.tError.replace("%url%", o.src))
					}
				}, h.st.ajax.settings);
	...
	c.magnificPopup.registerModule("image", {
		...
		proto: {
			initImage: function () {
				var e = h.st.image,
					t = ".image";
				h.types.push("image"), b(m + t, function () {
				...
				}), b("Resize" + t, h.resizeImage), h.isLowIE && b("AfterChange", h.resizeImage)
			},
			...
			_onImageHasSize: function (e) {
				e.img && (e.hasSize = !0, O && clearInterval(O), e.isCheckingImgSize = !1, _("ImageHasSize", e), e.imgHidden && (h.content && h.content.removeClass("mfp-loading"), e.imgHidden = !1))
			},
				...
				var n = 0,
					...
					o = function (e) {
						O && clearInterval(O), O = setInterval(function () {
							0 < i.naturalWidth ? h._onImageHasSize(t) : (200 < n && clearInterval(O), 3 === ++n ? o(10) : 40 === n ? o(50) : 100 === n && o(500))
						}, e)
					};
				o(1)
			},
			getImage: function (e, t) {
				var n = 0,
					i = function () {
						e && (e.img[0].complete ? (e.img.off(".mfploader"), e === h.currItem && (h._onImageHasSize(e), h.updateStatus("ready")), e.hasSize = !0, e.loaded = !0, _("ImageLoadComplete")) : ++n < 200 ? setTimeout(i, 100) : o())
					},
					o = function () {
				...
				if (s.length) {
					...
					a.className = "mfp-img", e.el && e.el.find("img").length && (a.alt = e.el.find("img").attr("alt")), e.img = c(a).on("load.mfploader", i).on("error.mfploader", o), a.src = e.src, s.is("img") && (e.img = e.img.clone()), 0 < (a = e.img[0]).naturalWidth ? e.hasSize = !0 : a.width || (e.hasSize = !1)
				}
				...
				}, e), h.resizeImage(), e.hasSize ? (O && clearInterval(O), e.loadError ? (t.addClass("mfp-loading"), h.updateStatus("error", r.tError.replace("%url%", e.src))) : (t.removeClass("mfp-loading"), h.updateStatus("ready"))) : (h.updateStatus("loading"), e.loading = !0, e.hasSize || (e.imgHidden = !0, t.addClass("mfp-loading"), h.findImageSize(e))), t
			}
		}
	});
	var N;
	c.magnificPopup.registerModule("zoom", {
		...
		proto: {
			initZoom: function () {
				...
				if (r.enabled && h.supportsTransition) {
					...
					b("BuildControls" + t, function () {
						if (h._allowZoom()) {
							if (clearTimeout(n), h.content.css("visibility", "hidden"), !(e = h._getItemToZoom())) return void a();
							(i = s(e)).css(h._getOffset()), h.wrap.append(i), n = setTimeout(function () {
								i.css(h._getOffset(!0)), n = setTimeout(function () {
									a(), setTimeout(function () {
										i.remove(), e = i = null, _("ZoomAnimationEnded")
									}, 16)
								}, o)
							}, 16)
						}
						...
						if (h._allowZoom()) {
							if (clearTimeout(n), h.st.removalDelay = o, !e) {
						...
						h._allowZoom() && (a(), i && i.remove(), e = null)
					})
				}
			},
			_allowZoom: function () {
			...
			_getOffset: function (e) {
				var t, n = (t = e ? h.currItem.img : h.st.zoom.opener(h.currItem.el || h.currItem)).offset(),
	...
	var H = "iframe",
		$ = function (e) {
			if (h.currTemplate[H]) {
				var t = h.currTemplate[H].find("iframe");
	...
	c.magnificPopup.registerModule(H, {
		...
		proto: {
			initIframe: function () {
				h.types.push(H), b("BeforeChange", function (e, t, n) {
					t !== n && (t === H ? $() : n === H && $(!0))
				}), b(l + "." + H, function () {
					$()
				})
			...
			getIframe: function (e, t) {
				...
				var o = {};
				return i.srcAction && (o[i.srcAction] = n), h._parseMarkup(t, o, e), h.updateStatus("ready"), t
			}
		}
	});
	var L = function (e) {
		...
		proto: {
			initGallery: function () {
				...
				f += " mfp-gallery", b(m + e, function () {
					...
					t.text && (t.text = P(t.text, h.currItem.index, h.items.length))
				}), b(p + e, function (e, t, n, i) {
					var o = h.items.length;
					n.counter = 1 < o ? P(r.tCounter, i.index, o) : ""
				}), b("BuildControls" + e, function () {
					if (1 < h.items.length && r.arrows && !h.arrowLeft) {
						var e = r.arrowMarkup,
							t = h.arrowLeft = c(e.replace(/%title%/gi, r.tPrev).replace(/%dir%/gi, "left")).addClass(s),
							n = h.arrowRight = c(e.replace(/%title%/gi, r.tNext).replace(/%dir%/gi, "right")).addClass(s);
						t.click(function () {
							h.prev()
						}), n.click(function () {
							h.next()
						}), h.container.append(t.add(n))
					}
				}), b("Change" + e, function () {
					...
					d.off(e), h.wrap.off("click" + e), h.arrowRight = h.arrowLeft = null
				})
			},
			next: function () {
				h.direction = !0, h.index = L(h.index + 1), h.updateItemHTML()
			},
			prev: function () {
				h.direction = !1, h.index = L(h.index - 1), h.updateItemHTML()
			},
			goTo: function (e) {
		...
		proto: {
			initRetina: function () {
				if (1 < window.devicePixelRatio) {
					var n = h.st.retina,
						i = n.ratio;
					1 < (i = isNaN(i) ? i() : i) && (b("ImageHasSize." + j, function (e, t) {
						t.img.css({
...
function (e) {
	...
	"indexOf" in Array.prototype || (Array.prototype.indexOf = function (e, t) {
		t === s && (t = 0), t < 0 && (t += this.length), t < 0 && (t = 0);
	...
	var y = function (e, r) {
		...
		this.element = E(e), this.container = r.container || "body", this.language = r.language || this.element.data("date-language") || "en", this.language = this.language in M ? this.language : this.language.split("-")[0], this.language = this.language in M ? this.language : "en", this.isRTL = M[this.language].rtl || !1, this.formatType = r.formatType || this.element.data("format-type") || "standard", this.format = I.parseFormat(r.format || this.element.data("date-format") || M[this.language].format || I.getDefaultFormat(this.formatType, "input"), this.formatType), this.isInline = !1, this.isVisible = !1, this.isInput = this.element.is("input"), this.fontAwesome = r.fontAwesome || this.element.data("font-awesome") || !1, this.bootcssVer = r.bootcssVer || (this.isInput ? this.element.is(".form-control") ? 3 : 2 : this.bootcssVer = this.element.is(".input-group") ? 3 : 2), this.component = !!this.element.is(".date") && (3 === this.bootcssVer ? this.element.find(".input-group-addon .glyphicon-th, .input-group-addon .glyphicon-time, .input-group-addon .glyphicon-remove, .input-group-addon .glyphicon-calendar, .input-group-addon .fa-calendar, .input-group-addon .fa-clock-o").parent() : this.element.find(".add-on .icon-th, .add-on .icon-time, .add-on .icon-calendar, .add-on .fa-calendar, .add-on .fa-clock-o").parent()), this.componentReset = !!this.element.is(".date") && (3 === this.bootcssVer ? this.element.find(".input-group-addon .glyphicon-remove, .input-group-addon .fa-times").parent() : this.element.find(".add-on .icon-remove, .add-on .fa-times").parent()), this.hasInput = this.component && this.element.find("input").length, this.component && 0 === this.component.length && (this.component = !1), this.linkField = r.linkField || this.element.data("link-field") || !1, this.linkFormat = I.parseFormat(r.linkFormat || this.element.data("link-format") || I.getDefaultFormat(this.formatType, "link"), this.formatType), this.minuteStep = r.minuteStep || this.element.data("minute-step") || 5, this.pickerPosition = r.pickerPosition || this.element.data("picker-position") || "bottom-right", this.showMeridian = r.showMeridian || this.element.data("show-meridian") || !1, this.initialDate = r.initialDate || new Date, this.zIndex = r.zIndex || this.element.data("z-index") || s, this.title = void 0 !== r.title && r.title, this.timezone = r.timezone || function () {
			...
			0 === E(e.target).closest(".datetimepicker").length && t.hide()
		...
		for (var n = 3 === this.bootcssVer ? I.templateV3 : I.template; - 1 !== n.indexOf("{iconType}");) n = n.replace("{iconType}", this.icontype);
		for (; - 1 !== n.indexOf("{leftArrow}");) n = n.replace("{leftArrow}", this.icons.leftArrow);
		for (; - 1 !== n.indexOf("{rightArrow}");) n = n.replace("{rightArrow}", this.icons.rightArrow);
		if (this.picker = E(n).appendTo(this.isInline ? this.element : this.container).on({
		...
		E(document).on("mousedown touchend", this.clickedOutside), this.autoclose = !1, "autoclose" in r ? this.autoclose = r.autoclose : "dateAutoclose" in this.element.data() && (this.autoclose = this.element.data("date-autoclose")), this.keyboardNavigation = !0, "keyboardNavigation" in r ? this.keyboardNavigation = r.keyboardNavigation : "dateKeyboardNavigation" in this.element.data() && (this.keyboardNavigation = this.element.data("date-keyboard-navigation")), this.todayBtn = r.todayBtn || this.element.data("date-today-btn") || !1, this.clearBtn = r.clearBtn || this.element.data("date-clear-btn") || !1, this.todayHighlight = r.todayHighlight || this.element.data("date-today-highlight") || !1, void(this.weekStart = 0) !== r.weekStart ? this.weekStart = r.weekStart : void 0 !== this.element.data("date-weekstart") ? this.weekStart = this.element.data("date-weekstart") : void 0 !== M[this.language].weekStart && (this.weekStart = M[this.language].weekStart), this.weekStart = this.weekStart % 7, this.weekEnd = (this.weekStart + 6) % 7, this.onRenderDay = function (e) {
			...
			return (e < this.startDate || o < i) && n.push("disabled"), n.concat(t || [])
		}, this.onRenderMonth = function (e) {
			var t = (r.onRenderMonth || function () {
				return []
			})(e);
			return "string" == typeof t && (t = [t]), ["month"].concat(t || [])
		}, this.startDate = new Date(-8639968443048e3), this.endDate = new Date(8639968443048e3), this.datesDisabled = [], this.daysOfWeekDisabled = [], this.setStartDate(r.startDate || this.element.data("date-startdate")), this.setEndDate(r.endDate || this.element.data("date-enddate")), this.setDatesDisabled(r.datesDisabled || this.element.data("date-dates-disabled")), this.setDaysOfWeekDisabled(r.daysOfWeekDisabled || this.element.data("date-days-of-week-disabled")), this.setMinutesDisabled(r.minutesDisabled || this.element.data("date-minute-disabled")), this.setHoursDisabled(r.hoursDisabled || this.element.data("date-hour-disabled")), this.fillDow(), this.fillMonths(), this.update(), this.showMode(), this.isInline && this.show()
	};
	y.prototype = {
		constructor: y,
		_events: [],
		_attachEvents: function () {
			...
			for (var e, t, n = 0; n < this._events.length; n++) e = this._events[n][0], t = this._events[n][1], e.on(t)
		},
		...
		show: function (e) {
			this.picker.show(), this.height = this.component ? this.component.outerHeight() : this.element.outerHeight(), this.forceParse && this.update(), this.place(), E(window).on("resize", E.proxy(this.place, this)), e && (e.stopPropagation(), e.preventDefault()), this.isVisible = !0, this.element.trigger({
				type: "show",
				date: this.date
			})
		},
		...
		setFormat: function (e) {
			var t;
			this.format = I.parseFormat(e, this.formatType), this.isInput ? t = this.element : this.component && (t = this.element.find("input")), t && t.val() && this.setValue()
		},
		setValue: function () {
			var e = this.getFormattedDate();
			this.isInput ? this.element.val(e) : (this.component && this.element.find("input").val(e), this.element.data("date", e)), this.linkField && E("#" + this.linkField).val(this.getFormattedDate(this.linkFormat))
		},
		getFormattedDate: function (e) {
			return e = e || this.format, I.formatDate(this.date, e, this.language, this.formatType, this.timezone)
		},
		setStartDate: function (e) {
			this.startDate = e || this.startDate, 8639968443048e3 !== this.startDate.valueOf() && (this.startDate = I.parseDate(this.startDate, this.format, this.language, this.formatType, this.timezone)), this.update(), this.updateNavArrows()
		},
		setEndDate: function (e) {
			this.endDate = e || this.endDate, 8639968443048e3 !== this.endDate.valueOf() && (this.endDate = I.parseDate(this.endDate, this.format, this.language, this.formatType, this.timezone)), this.update(), this.updateNavArrows()
		},
		setDatesDisabled: function (e) {
			this.datesDisabled = e || [], E.isArray(this.datesDisabled) || (this.datesDisabled = this.datesDisabled.split(/,\s*/));
			var t = this;
			this.datesDisabled = E.map(this.datesDisabled, function (e) {
				return I.parseDate(e, t.format, t.language, t.formatType, t.timezone).toDateString()
			}), this.update(), this.updateNavArrows()
		},
		setTitle: function (e, t) {
			return this.picker.find(e).find("th:eq(1)").text(!1 === this.title ? t : this.title)
		},
		setDaysOfWeekDisabled: function (e) {
			this.daysOfWeekDisabled = e || [], E.isArray(this.daysOfWeekDisabled) || (this.daysOfWeekDisabled = this.daysOfWeekDisabled.split(/,\s*/)), this.daysOfWeekDisabled = E.map(this.daysOfWeekDisabled, function (e) {
				return parseInt(e, 10)
			}), this.update(), this.updateNavArrows()
		},
		setMinutesDisabled: function (e) {
			this.minutesDisabled = e || [], E.isArray(this.minutesDisabled) || (this.minutesDisabled = this.minutesDisabled.split(/,\s*/)), this.minutesDisabled = E.map(this.minutesDisabled, function (e) {
				return parseInt(e, 10)
			}), this.update(), this.updateNavArrows()
		},
		setHoursDisabled: function (e) {
			this.hoursDisabled = e || [], E.isArray(this.hoursDisabled) || (this.hoursDisabled = this.hoursDisabled.split(/,\s*/)), this.hoursDisabled = E.map(this.hoursDisabled, function (e) {
				return parseInt(e, 10)
			}), this.update(), this.updateNavArrows()
		},
		place: function () {
			if (!this.isInline) {
				if (!this.zIndex) {
					var t = 0;
					E("div").each(function () {
						var e = parseInt(E(this).css("zIndex"), 10);
						t < e && (t = e)
					}), this.zIndex = t + 10
				}
				var e, n, i, o;
				o = this.container instanceof E ? this.container.offset() : E(this.container).offset(), this.component ? (i = (e = this.component.offset()).left, "bottom-left" !== this.pickerPosition && "top-left" !== this.pickerPosition || (i += this.component.outerWidth() - this.picker.outerWidth())) : (i = (e = this.element.offset()).left, "bottom-left" !== this.pickerPosition && "top-left" !== this.pickerPosition || (i += this.element.outerWidth() - this.picker.outerWidth()));
				var r = document.body.clientWidth || window.innerWidth;
				r < i + 220 && (i = r - 220), n = "top-left" === this.pickerPosition || "top-right" === this.pickerPosition ? e.top - this.picker.outerHeight() : e.top + this.height, n -= o.top, i -= o.left, this.picker.css({
					top: n,
					left: i,
					zIndex: this.zIndex
				})
		...
		fillDow: function () {
			for (var e = this.weekStart, t = "<tr>"; e < this.weekStart + 7;) t += '<th class="dow">' + M[this.language].daysMin[e++ % 7] + "</th>";
			t += "</tr>", this.picker.find(".datetimepicker-days thead").append(t)
		},
		fillMonths: function () {
			for (var e = "", t = new Date(this.viewDate), n = 0; n < 12; n++) {
				t.setUTCMonth(n), e += '<span class="' + this.onRenderMonth(t).join(" ") + '">' + M[this.language].monthsShort[n] + "</span>"
			}
		...
		fill: function () {
			if (this.date && this.viewDate) {
				var e = new Date(this.viewDate),
					...
					i = e.getUTCDate(),
					o = e.getUTCHours(),
					r = this.startDate.getUTCFullYear(),
					s = this.startDate.getUTCMonth(),
					a = this.endDate.getUTCFullYear(),
					l = this.endDate.getUTCMonth() + 1,
					u = new k(this.date.getUTCFullYear(), this.date.getUTCMonth(), this.date.getUTCDate()).valueOf(),
					c = new Date;
				if (this.setTitle(".datetimepicker-days", M[this.language].months[n] + " " + t), "time" === this.formatViewType) {
					var h = this.getFormattedDate();
					this.setTitle(".datetimepicker-hours", h), this.setTitle(".datetimepicker-minutes", h)
				} else this.setTitle(".datetimepicker-hours", i + " " + M[this.language].months[n] + " " + t), this.setTitle(".datetimepicker-minutes", i + " " + M[this.language].months[n] + " " + t);
				this.picker.find("tfoot th.today").text(M[this.language].today || M.en.today).toggle(!1 !== this.todayBtn), this.picker.find("tfoot th.clear").text(M[this.language].clear || M.en.clear).toggle(!1 !== this.clearBtn), this.updateNavArrows(), this.fillMonths();
				var d = k(t, n - 1, 28, 0, 0, 0, 0),
					f = I.getDaysInMonth(d.getUTCFullYear(), d.getUTCMonth());
				d.setUTCDate(f), d.setUTCDate(f - (d.getUTCDay() - this.weekStart + 7) % 7);
				var p = new Date(d);
				p.setUTCDate(p.getUTCDate() + 42), p = p.valueOf();
				for (var m, g = []; d.valueOf() < p;) d.getUTCDay() === this.weekStart && g.push("<tr>"), m = this.onRenderDay(d), d.getUTCFullYear() < t || d.getUTCFullYear() === t && d.getUTCMonth() < n ? m.push("old") : (d.getUTCFullYear() > t || d.getUTCFullYear() === t && d.getUTCMonth() > n) && m.push("new"), this.todayHighlight && d.getUTCFullYear() === c.getFullYear() && d.getUTCMonth() === c.getMonth() && d.getUTCDate() === c.getDate() && m.push("today"), d.valueOf() === u && m.push("active"), (d.valueOf() + 864e5 <= this.startDate || d.valueOf() > this.endDate || -1 !== E.inArray(d.getUTCDay(), this.daysOfWeekDisabled) || -1 !== E.inArray(d.toDateString(), this.datesDisabled)) && m.push("disabled"), g.push('<td class="' + m.join(" ") + '">' + d.getUTCDate() + "</td>"), d.getUTCDay() === this.weekEnd && g.push("</tr>"), d.setUTCDate(d.getUTCDate() + 1);
				this.picker.find(".datetimepicker-days tbody").empty().append(g.join("")), g = [];
				var v = "",
					y = "",
					b = "",
					w = this.hoursDisabled || [];
				e = new Date(this.viewDate);
				for (var _ = 0; _ < 24; _++) {
					e.setUTCHours(_), m = this.onRenderHour(e), -1 !== w.indexOf(_) && m.push("disabled");
					var T = k(t, n, i, _);
					T.valueOf() + 36e5 <= this.startDate || T.valueOf() > this.endDate ? m.push("disabled") : o === _ && m.push("active"), this.showMeridian && 2 === M[this.language].meridiem.length ? ((y = _ < 12 ? M[this.language].meridiem[0] : M[this.language].meridiem[1]) !== b && ("" !== b && g.push("</fieldset>"), g.push('<fieldset class="hour"><legend>' + y.toUpperCase() + "</legend>")), b = y, v = _ % 12 ? _ % 12 : 12, _ < 12 ? m.push("hour_am") : m.push("hour_pm"), g.push('<span class="' + m.join(" ") + '">' + v + "</span>"), 23 === _ && g.push("</fieldset>")) : (v = _ + ":00", g.push('<span class="' + m.join(" ") + '">' + v + "</span>"))
				}
				this.picker.find(".datetimepicker-hours td").html(g.join("")), g = [], b = y = v = "";
				var C = this.minutesDisabled || [];
				e = new Date(this.viewDate);
				for (_ = 0; _ < 60; _ += this.minuteStep) - 1 === C.indexOf(_) && (e.setUTCMinutes(_), e.setUTCSeconds(0), m = this.onRenderMinute(e), this.showMeridian && 2 === M[this.language].meridiem.length ? ((y = o < 12 ? M[this.language].meridiem[0] : M[this.language].meridiem[1]) !== b && ("" !== b && g.push("</fieldset>"), g.push('<fieldset class="minute"><legend>' + y.toUpperCase() + "</legend>")), b = y, v = o % 12 ? o % 12 : 12, g.push('<span class="' + m.join(" ") + '">' + v + ":" + (_ < 10 ? "0" + _ : _) + "</span>"), 59 === _ && g.push("</fieldset>")) : (v = _ + ":00", g.push('<span class="' + m.join(" ") + '">' + o + ":" + (_ < 10 ? "0" + _ : _) + "</span>")));
				this.picker.find(".datetimepicker-minutes td").html(g.join(""));
				var S = this.date.getUTCFullYear(),
					D = this.setTitle(".datetimepicker-months", t).end().find(".month").removeClass("active");
				S === t && D.eq(this.date.getUTCMonth()).addClass("active"), (t < r || a < t) && D.addClass("disabled"), t === r && D.slice(0, s).addClass("disabled"), t === a && D.slice(l).addClass("disabled"), g = "", t = 10 * parseInt(t / 10, 10);
				var x = this.setTitle(".datetimepicker-years", t + "-" + (t + 9)).end().find("td");
				t -= 1, e = new Date(this.viewDate);
				for (_ = -1; _ < 11; _++) e.setUTCFullYear(t), m = this.onRenderYear(e), -1 !== _ && 10 !== _ || m.push(A), g += '<span class="' + m.join(" ") + '">' + t + "</span>", t += 1;
				x.html(g), this.place()
			}
		},
		...
		mousewheel: function (e) {
			if (e.preventDefault(), e.stopPropagation(), !this.wheelPause) {
				...
				var t = e.originalEvent.wheelDelta,
					n = 0 < t ? 1 : 0 === t ? 0 : -1;
				this.wheelViewModeNavigationInverseDirection && (n = -n), this.showMode(n), setTimeout(E.proxy(function () {
					this.wheelPause = !1
		...
		click: function (e) {
			...
			var t = E(e.target).closest("span, td, th, legend");
			if (t.is("." + this.icontype) && (t = E(t).parent().closest("span, td, th, legend")), 1 === t.length) {
				...
				switch (t[0].nodeName.toLowerCase()) {
					case "th":
						switch (t[0].className) {
							...
							case "prev":
							case "next":
								var n = I.modes[this.viewMode].navStep * ("prev" === t[0].className ? -1 : 1);
								switch (this.viewMode) {
									case 0:
					...
					case "span":
						if (!t.is(".disabled")) {
							var o = this.viewDate.getUTCFullYear(),
								...
								s = this.viewDate.getUTCDate(),
								a = this.viewDate.getUTCHours(),
								l = this.viewDate.getUTCMinutes(),
								u = this.viewDate.getUTCSeconds();
							if (t.is(".month") ? (this.viewDate.setUTCDate(1), r = t.parent().find("span").index(t), s = this.viewDate.getUTCDate(), this.viewDate.setUTCMonth(r), this.element.trigger({
									type: "changeMonth",
									date: this.viewDate
								}), 3 <= this.viewSelect && this._setDate(k(o, r, s, a, l, u, 0))) : t.is(".year") ? (this.viewDate.setUTCDate(1), o = parseInt(t.text(), 10) || 0, this.viewDate.setUTCFullYear(o), this.element.trigger({
									type: "changeYear",
									date: this.viewDate
								}), 4 <= this.viewSelect && this._setDate(k(o, r, s, a, l, u, 0))) : t.is(".hour") ? (a = parseInt(t.text(), 10) || 0, (t.hasClass("hour_am") || t.hasClass("hour_pm")) && (12 === a && t.hasClass("hour_am") ? a = 0 : 12 !== a && t.hasClass("hour_pm") && (a += 12)), this.viewDate.setUTCHours(a), this.element.trigger({
									type: "changeHour",
									date: this.viewDate
								}), 1 <= this.viewSelect && this._setDate(k(o, r, s, a, l, u, 0))) : t.is(".minute") && (l = parseInt(t.text().substr(t.text().indexOf(":") + 1), 10) || 0, this.viewDate.setUTCMinutes(l), this.element.trigger({
									type: "changeMinute",
									date: this.viewDate
								}), 0 <= this.viewSelect && this._setDate(k(o, r, s, a, l, u, 0))), 0 !== this.viewMode) {
								var c = this.viewMode;
					...
					case "td":
						if (t.is(".day") && !t.is(".disabled")) {
							s = parseInt(t.text(), 10) || 1, o = this.viewDate.getUTCFullYear(), r = this.viewDate.getUTCMonth(), a = this.viewDate.getUTCHours(), l = this.viewDate.getUTCMinutes(), u = this.viewDate.getUTCSeconds();
							t.is(".old") ? 0 === r ? (r = 11, o -= 1) : r -= 1 : t.is(".new") && (11 === r ? (r = 0, o += 1) : r += 1), this.viewDate.setUTCFullYear(o), this.viewDate.setUTCMonth(r, s), this.element.trigger({
								type: "changeDay",
								date: this.viewDate
							}), 2 <= this.viewSelect && this._setDate(k(o, r, s, a, l, u, 0))
						}
						c = this.viewMode;
						this.showMode(-1), this.fill(), c === this.viewMode && this.autoclose && this.hide()
				}
		...
		_setDate: function (e, t) {
			var n;
			t && "date" !== t || (this.date = e), t && "view" !== t || (this.viewDate = e), this.fill(), this.setValue(), this.isInput ? n = this.element : this.component && (n = this.element.find("input")), n && n.change(), this.element.trigger({
				type: "changeDate",
				date: this.getDate()
		...
		moveMonth: function (e, t) {
			...
			}, n = s + t, o.setUTCMonth(n), (n < 0 || 11 < n) && (n = (n + 12) % 12);
			else {
			...
			if (this.picker.is(":not(:visible)")) 27 === e.keyCode && this.show();
				...
				switch (e.keyCode) {
					...
					case 39:
						...
						t = 37 === e.keyCode ? -1 : 1;
						var s = this.viewMode;
						e.ctrlKey ? s += 2 : e.shiftKey && (s += 1), 4 === s ? (n = this.moveYear(this.date, t), i = this.moveYear(this.viewDate, t)) : 3 === s ? (n = this.moveMonth(this.date, t), i = this.moveMonth(this.viewDate, t)) : 2 === s ? (n = this.moveDate(this.date, t), i = this.moveDate(this.viewDate, t)) : 1 === s ? (n = this.moveHour(this.date, t), i = this.moveHour(this.viewDate, t)) : 0 === s && (n = this.moveMinute(this.date, t), i = this.moveMinute(this.viewDate, t)), this.dateWithinRange(n) && (this.date = n, this.viewDate = i, this.setValue(), this.update(), e.preventDefault(), r = !0);
						break;
					case 38:
					case 40:
						if (!this.keyboardNavigation) break;
				...
				if (r) this.isInput ? o = this.element : this.component && (o = this.element.find("input")), o && o.change(), this.element.trigger({
					type: "changeDate",
					date: this.getDate()
				})
			}
		...
		showMode: function (e) {
			if (e) {
				var t = Math.max(0, Math.min(I.modes.length - 1, this.viewMode + e));
			...
			this.picker.find(">div").hide().filter(".datetimepicker-" + I.modes[this.viewMode].clsName).css("display", "block"), this.updateNavArrows()
		},
		reset: function () {
	...
	E.fn.datetimepicker = function (i) {
		...
		return r.shift(), this.each(function () {
			var e = E(this),
				...
				n = "object" == typeof i && i;
			if (t || e.data("datetimepicker", t = new y(this, E.extend({}, E.fn.datetimepicker.defaults, n))), "string" == typeof i && "function" == typeof t[i] && (o = t[i].apply(t, r)) !== s) return !1
		}), o !== s ? o : this
	}, E.fn.datetimepicker.defaults = {}, E.fn.datetimepicker.Constructor = y;
	var M = E.fn.datetimepicker.dates = {
			en: {
		...
		I = {
			...
			parseDate: function (e, t, n, i, o) {
				if (e instanceof Date) {
					var r = new Date(e.valueOf() - 6e4 * e.getTimezoneOffset());
					return r.setMilliseconds(0), r
				}
				if (/^\d{4}\-\d{1,2}\-\d{1,2}$/.test(e) && (t = this.parseFormat("yyyy-mm-dd", i)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}$/.test(e) && (t = this.parseFormat("yyyy-mm-dd hh:ii", i)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}\:\d{1,2}[Z]{0,1}$/.test(e) && (t = this.parseFormat("yyyy-mm-dd hh:ii:ss", i)), /^[-+]\d+[dmwy]([\s,]+[-+]\d+[dmwy])*$/.test(e)) {
					var s, a = /([-+]\d+)([dmwy])/,
						l = e.match(/([-+]\d+)([dmwy])/g);
					e = new Date;
					for (var u = 0; u < l.length; u++) switch (d = a.exec(l[u]), s = parseInt(d[1]), d[2]) {
						case "d":
							e.setUTCDate(e.getUTCDate() + s);
							break;
						case "m":
							e = y.prototype.moveMonth.call(y.prototype, e, s);
							break;
						case "w":
							e.setUTCDate(e.getUTCDate() + 7 * s);
							break;
						case "y":
							e = y.prototype.moveYear.call(y.prototype, e, s)
					}
					return k(e.getUTCFullYear(), e.getUTCMonth(), e.getUTCDate(), e.getUTCHours(), e.getUTCMinutes(), e.getUTCSeconds(), 0)
				}
				l = e && e.toString().match(this.nonpunctuation) || [], e = new Date(0, 0, 0, 0, 0, 0, 0);
				var c, h, d, f = {},
				...
				if (m.M = m.MM = m.mm = m.m, m.dd = m.d, m.P = m.p, m.Z = m.z, e = k(e.getFullYear(), e.getMonth(), e.getDate(), e.getHours(), e.getMinutes(), e.getSeconds()), l.length === t.parts.length) {
					u = 0;
					for (var g = t.parts.length; u < g; u++) {
						if (c = parseInt(l[u], 10), d = t.parts[u], isNaN(c)) switch (d) {
							case "MM":
								h = E(M[n].months).filter(function () {
									var e = this.slice(0, l[u].length);
									return e === l[u].slice(0, e.length)
								}), c = E.inArray(h[0], M[n].months) + 1;
								break;
							case "M":
								h = E(M[n].monthsShort).filter(function () {
									var e = this.slice(0, l[u].length),
										t = l[u].slice(0, e.length);
									return e.toLowerCase() === t.toLowerCase()
								}), c = E.inArray(h[0], M[n].monthsShort) + 1;
								break;
							case "p":
							case "P":
								c = E.inArray(l[u].toLowerCase(), M[n].meridiem)
						}
						f[d] = c
					}
					var v;
					for (u = 0; u < p.length; u++)(v = p[u]) in f && !isNaN(f[v]) && m[v](e, f[v])
				}
				return e
			},
			formatDate: function (e, t, n, i, o) {
				if (null === e) return "";
				var r;
				if ("standard" === i) r = {
					t: e.getTime(),
					...
					p: 2 === M[n].meridiem.length ? M[n].meridiem[e.getUTCHours() < 12 ? 0 : 1] : "",
					h: e.getUTCHours(),
					i: e.getUTCMinutes(),
					s: e.getUTCSeconds(),
					z: o
				}, 2 === M[n].meridiem.length ? r.H = r.h % 12 == 0 ? 12 : r.h % 12 : r.H = r.h, r.HH = (r.H < 10 ? "0" : "") + r.H, r.P = r.p.toUpperCase(), r.Z = r.z, r.hh = (r.h < 10 ? "0" : "") + r.h, r.ii = (r.i < 10 ? "0" : "") + r.i, r.ss = (r.s < 10 ? "0" : "") + r.s, r.dd = (r.d < 10 ? "0" : "") + r.d, r.mm = (r.m < 10 ? "0" : "") + r.m;
				else {
					if ("php" !== i) throw new Error("Invalid format type.");
					(r = {
						y: e.getUTCFullYear().toString().substring(2),
						Y: e.getUTCFullYear(),
						F: M[n].months[e.getUTCMonth()],
						M: M[n].monthsShort[e.getUTCMonth()],
						n: e.getUTCMonth() + 1,
						t: I.getDaysInMonth(e.getUTCFullYear(), e.getUTCMonth()),
						j: e.getUTCDate(),
						l: M[n].days[e.getUTCDay()],
						D: M[n].daysShort[e.getUTCDay()],
						w: e.getUTCDay(),
						N: 0 === e.getUTCDay() ? 7 : e.getUTCDay(),
						S: e.getUTCDate() % 10 <= M[n].suffix.length ? M[n].suffix[e.getUTCDate() % 10 - 1] : "",
						a: 2 === M[n].meridiem.length ? M[n].meridiem[e.getUTCHours() < 12 ? 0 : 1] : "",
				...
				e = [];
				for (var s = E.extend([], t.separators), a = 0, l = t.parts.length; a < l; a++) s.length && e.push(s.shift()), e.push(r[t.parts[a]]);
				return s.length && e.push(s.shift()), e.join("")
			},
	...
	return function () {
		var m, t, g, v = 0,
			...
			e = {
				clear: function (e, t) {
					var n = w();
					m || y(n), a(e, n, t) || function (e) {
						for (var t = m.children(), n = t.length - 1; 0 <= n; n--) a(T(t[n]), e)
					}(n)
				},
				remove: function (e) {
					var t = w();
					m || y(t), e && 0 === T(":focus", e).length ? _(e) : m.children().length && m.remove()
				},
		...
		function y(e, t) {
			return e || (e = w()), (m = T("#" + e.containerId)).length || t && (n = e, (m = T("<div/>").attr("id", n.containerId).addClass(n.positionClass).attr("aria-live", "polite").attr("role", "alert")).appendTo(T(n.target)), m = m), m;
			var n
		}
		...
		function l(e) {
			var t = w(),
				n = e.iconClass || t.iconClass;
			if (void 0 !== e.optionsOverride && (t = T.extend(t, e.optionsOverride), n = e.optionsOverride.iconClass || n), ! function (e, t) {
					if (e.preventDuplicates) {
						if (t.message === g) return !0;
						g = t.message
					}
					return !1
				}(t, e)) {
				...
				return e.iconClass && o.addClass(t.toastClass).addClass(n), e.title && (r.append(e.title).addClass(t.titleClass), o.append(r)), e.message && (s.append(e.message).addClass(t.messageClass), o.append(s)), t.closeButton && (l.addClass("toast-close-button").attr("role", "button"), o.prepend(l)), t.progressBar && (a.addClass("toast-progress"), o.prepend(a)), t.newestOnTop ? m.prepend(o) : m.append(o), o.hide(), o[t.showMethod]({
					duration: t.showDuration,
					easing: t.showEasing,
					complete: t.onShown
				}), 0 < t.timeOut && (i = setTimeout(h, t.timeOut), u.maxHideTime = parseFloat(t.timeOut), u.hideEta = (new Date).getTime() + u.maxHideTime, t.progressBar && (u.intervalId = setInterval(p, 10))), o.hover(f, d), !t.onclick && t.tapToDismiss && o.click(h), t.closeButton && l && l.click(function (e) {
					e.stopPropagation ? e.stopPropagation() : void 0 !== e.cancelBubble && !0 !== e.cancelBubble && (e.cancelBubble = !0), h(!0)
				}), t.onclick && o.click(function () {
					t.onclick(), h()
				}), b(c), t.debug && console && console.log(c), o
			}

			function h(e) {
				if (!T(":focus", o).length || e) return clearTimeout(u.intervalId), o[t.hideMethod]({
					duration: t.hideDuration,
					easing: t.hideEasing,
					complete: function () {
						_(o), t.onHidden && "hidden" !== c.state && t.onHidden(), c.state = "hidden", c.endTime = new Date, b(c)
					}
				})
			}

			function d() {
				(0 < t.timeOut || 0 < t.extendedTimeOut) && (i = setTimeout(h, t.extendedTimeOut), u.maxHideTime = parseFloat(t.extendedTimeOut), u.hideEta = (new Date).getTime() + u.maxHideTime)
			}

			function f() {
				clearTimeout(i), u.hideEta = 0, o.stop(!0, !0)[t.showMethod]({
					duration: t.showDuration,
					easing: t.showEasing
				})
			}
		...
		function _(e) {
			m || (m = y()), e.is(":visible") || (e.remove(), e = null, 0 === m.children().length && (m.remove(), g = void 0))
		}
	}()
}),
function (e) {
	...
	function initMouseDetection(e) {
		...
		if (mouseDetectionEnabled || e) mouseDetectionEnabled && e && ($(document).off(t), mouseDetectionEnabled = !1);
			...
			var r = !0,
				...
				n = {
					mousemove: function (e) {
						...
						if (s) {
							var n = Math.abs(s.x - t.x),
								i = Math.abs(s.y - t.y);
							if ((0 < n || 0 < i) && n <= 2 && i <= 2 && t.timeStamp - s.timeStamp <= 300 && (mouse = !0, r)) {
			...
			n[touchEvents ? "touchstart" : "pointerover pointermove pointerout MSPointerOver MSPointerMove MSPointerOut"] = function (e) {
				isTouchEvent(e.originalEvent) && (mouse = !1)
			}, $(document).on(getEventsNS(n, t)), mouseDetectionEnabled = !0
		}
	}
	...
	function getEventsNS(e, t) {
		t || (t = "");
		var n = {};
		for (var i in e) n[i.split(" ").join(t + " ") + t] = e[i];
		return n
	}
		...
		prototype: {
			init: function (e) {
				...
				if (!e) {
					...
					}, t), "a"), t += this.rootId, this.opts.hideOnClick && $(document).on(getEventsNS({
					...
					}, t)), this.opts.subIndicators && (this.$subArrow = $("<span/>").addClass("sub-arrow"), this.opts.subIndicatorsText && this.$subArrow.html(this.opts.subIndicatorsText)), initMouseDetection()
				}
				if (this.$firstSub = this.$root.find("ul").each(function () {
					...
					this.$root.find("a").each(function () {
						var e = this.href.replace(i, ""),
							t = $(this);
						e != o && e != r || (t.addClass("current"), n.opts.markCurrentTree && t.parentsUntil("[data-smartmenus-id]", "ul").each(function () {
			...
			docClick: function (e) {
				this.$touchScrollingSub ? this.$touchScrollingSub = null : (this.visibleSubMenus.length && !$.contains(this.$root[0], e.target) || $(e.target).closest("a").length) && this.menuHideAll()
			},
			...
			getOffset: function (e, t) {
				...
				var i = e[0].getBoundingClientRect && e[0].getBoundingClientRect(),
					o = i && (t ? i.height || i.bottom - i.top : i.width || i.right - i.left);
				return o || 0 === o || (o = t ? e[0].offsetHeight : e[0].offsetWidth), n && e.hide().css(n), o
			},
			...
			itemActivate: function (e, t) {
				var n = e.closest("ul"),
					i = n.dataSM("level");
				if (1 < i && (!this.activatedItems[i - 2] || this.activatedItems[i - 2][0] != n.dataSM("parent-a")[0])) {
					var o = this;
					$(n.parentsUntil("[data-smartmenus-id]", "ul").get().reverse()).add(n).each(function () {
						o.itemActivate($(this).dataSM("parent-a"))
					})
				}
				if (this.isCollapsible() && !t || this.menuHideSubMenus(this.activatedItems[i - 1] && this.activatedItems[i - 1][0] == e[0] ? i : i - 1), this.activatedItems[i - 1] = e, !1 !== this.$root.triggerHandler("activate.smapi", e[0])) {
					var r = e.dataSM("sub");
			...
			itemClick: function (e) {
				...
				if (this.handleItemEvents(t)) {
					...
					if (i && !i.is(":visible")) {
						if ((!a || !r || n) && (this.opts.showOnClick && o && (this.clickActivated = !0), this.itemActivate(t, l), i.is(":visible"))) return !(this.focusActivated = !0)
					} else if (r && (s || n)) return this.itemActivate(t, l), this.menuHide(i), s && (this.focusActivated = !1), !1;
					return !(this.opts.showOnClick && o || t.hasClass("disabled") || !1 === this.$root.triggerHandler("select.smapi", t[0])) && void 0
				}
			},
			itemDown: function (e) {
				var t = $(e.currentTarget);
			...
			menuHideSubMenus: function (e) {
				for (var t = this.activatedItems.length - 1; e <= t; t--) {
			...
			menuInit: function (e) {
				if (!e.dataSM("in-mega")) {
					...
					var i = e.prevAll("a").eq(-1);
					i.length || (i = e.prevAll().find("a").eq(-1)), i.addClass("has-submenu").dataSM("sub", e), e.dataSM("parent-a", i).dataSM("level", t).parent().dataSM("sub", e);
			...
			menuPosition: function (t) {
				var e, n, i = t.dataSM("parent-a"),
					...
					_ = 2 == s ? this.opts.mainMenuSubOffsetX : this.opts.subMenusSubOffsetX,
					T = 2 == s ? this.opts.mainMenuSubOffsetY : this.opts.subMenusSubOffsetY;
				if (n = b ? (e = w ? d - a - _ : _, this.opts.bottomToTopSubMenus ? -l - T : f + T) : (e = w ? _ - a : d - _, this.opts.bottomToTopSubMenus ? f - T - l : T), this.opts.keepInViewport) {
					var C = c + e,
						S = h + n;
					if (w && C < m ? e = b ? m - C + e : d - _ : !w && m + v < C + a && (e = b ? m + v - a - C + e : _ - a), b || (l < y && g + y < S + l ? n += g + y - l - S : (y <= l || S < g) && (n += g - S)), b && (g + y + .49 < S + l || S < g) || !b && y + .49 < l) {
						var D = this;
						t.dataSM("scroll-arrows") || t.dataSM("scroll-arrows", $([$('<span class="scroll-up"><span class="scroll-up-arrow"></span></span>')[0], $('<span class="scroll-down"><span class="scroll-down-arrow"></span></span>')[0]]).on({
							mouseenter: function () {
								t.dataSM("scroll").up = $(this).hasClass("scroll-up"), D.menuScroll(t)
							},
							mouseleave: function (e) {
								D.menuScrollStop(t), D.menuScrollOut(t, e)
							},
							"mousewheel DOMMouseScroll": function (e) {
								e.preventDefault()
							}
						}).insertAfter(t));
						var x = ".smartmenus_scroll";
						if (t.dataSM("scroll", {
								...
								mouseover: function (e) {
									D.menuScrollOver(t, e)
								},
								mouseout: function (e) {
									D.menuScrollOut(t, e)
								},
								"mousewheel DOMMouseScroll": function (e) {
									D.menuScrollMousewheel(t, e)
								}
							}, x)).dataSM("scroll-arrows").css({
								top: "auto",
								left: "0",
							...
							var E = {};
							E[touchEvents ? "touchstart touchmove touchend" : "pointerdown pointermove pointerup MSPointerDown MSPointerMove MSPointerUp"] = function (e) {
								D.menuScrollTouch(t, e)
							}, t.css({
								"touch-action": "none",
			...
			menuScroll: function (e, t, n) {
				var i, o = e.dataSM("scroll"),
					r = e.dataSM("scroll-arrows"),
					s = o.up ? o.upEnd : o.downEnd;
				if (!t && o.momentum) {
					if (o.momentum *= .92, (i = o.momentum) < .5) return void this.menuScrollStop(e)
				} else i = n || (t || !this.opts.scrollAccelerate ? this.opts.scrollStep : Math.floor(o.step));
				var a = e.dataSM("level");
				if (this.activatedItems[a - 1] && this.activatedItems[a - 1].dataSM("sub") && this.activatedItems[a - 1].dataSM("sub").is(":visible") && this.menuHideSubMenus(a - 1), o.y = o.up && s <= o.y || !o.up && s >= o.y ? o.y : Math.abs(s - o.y) > i ? o.y + (o.up ? i : -i) : s, e.css(this.cssTransforms3d ? {
			...
			menuScrollMousewheel: function (e, t) {
				if (this.getClosestMenu(t.target) == e[0]) {
					var n = 0 < ((t = t.originalEvent).wheelDelta || -t.detail);
			...
			menuScrollOver: function (e, t) {
				if (mouse && !/^scroll-(up|down)/.test(t.target.className) && this.getClosestMenu(t.target) == e[0]) {
					...
					var n = e.dataSM("scroll"),
						i = $(window).scrollTop() - e.dataSM("parent-a").offset().top - n.itemH;
					e.dataSM("scroll-arrows").eq(0).css("margin-top", i).end().eq(1).css("margin-top", i + this.getViewportHeight() - n.arrowDownH).end().css("visibility", "visible")
				}
			},
			...
			menuScrollTouch: function (e, t) {
				if (isTouchEvent(t = t.originalEvent)) {
					...
					if (this.getClosestMenu(n.target) == e[0]) {
						...
						if (/(start|down)$/i.test(t.type)) this.menuScrollStop(e) ? (t.preventDefault(), this.$touchScrollingSub = e) : this.$touchScrollingSub = null, this.menuScrollRefreshData(e), $.extend(i, {
							touchStartY: n.pageY,
							...
							if (void 0 !== o && o != n.pageY) {
								...
								var r = o < n.pageY;
								void 0 !== i.up && i.up != r && $.extend(i, {
									touchStartY: n.pageY,
									touchStartTime: t.timeStamp
								}), $.extend(i, {
									up: r,
									touchY: n.pageY
								}), this.menuScroll(e, !0, Math.abs(n.pageY - o))
							}
							t.preventDefault()
						} else void 0 !== i.touchY && ((i.momentum = 15 * Math.pow(Math.abs(n.pageY - i.touchStartY) / (t.timeStamp - i.touchStartTime), 2)) && (this.menuScrollStop(e), this.menuScroll(e), t.preventDefault()), delete i.touchY)
					}
				}
			},
			menuShow: function (e) {
				if ((e.dataSM("beforefirstshowfired") || (e.dataSM("beforefirstshowfired", !0), !1 !== this.$root.triggerHandler("beforefirstshow.smapi", e[0]))) && !1 !== this.$root.triggerHandler("beforeshow.smapi", e[0]) && (e.dataSM("shown-before", !0), canAnimate && e.stop(!0, !0), !e.is(":visible"))) {
					...
					if ((this.opts.keepHighlighted || n) && t.addClass("highlighted"), n) e.removeClass("sm-nowrap").css({
						zIndex: "",
						width: "auto",
						minWidth: "",
						maxWidth: "",
					...
					n ? canAnimate && this.opts.collapsibleShowFunction ? this.opts.collapsibleShowFunction.call(this, e, o) : e.show(this.opts.collapsibleShowDuration, o) : canAnimate && this.opts.showFunction ? this.opts.showFunction.call(this, e, o) : e.show(this.opts.showDuration, o), t.attr("aria-expanded", "true"), e.attr({
						"aria-expanded": "true",
						"aria-hidden": "false"
...
function (e) {
	"function" == typeof define && define.amd ? define(["jquery", "smartmenus"], e) : "object" == typeof module && "object" == typeof module.exports ? module.exports = e(require("jquery")) : e(jQuery)
}(function (a) {
	return a.extend(a.SmartMenus.Bootstrap = {}, {
		keydownFix: !1,
		init: function () {
			var e = a("ul.navbar-nav:not([data-sm-skip])");
			e.each(function () {
				var n = a(this),
					o = n.data("smartmenus");
				if (!o) {
					var i, t = n.is("[data-sm-skip-collapsible-behavior]"),
						e = n.hasClass("ml-auto") || 0 < n.prevAll(".mr-auto").length;

					function r() {
						n.find("a.current").each(function () {
							var e = a(this);
							(e.hasClass("dropdown-item") ? e : e.parent()).addClass("active")
						}), n.find("a.has-submenu").each(function () {
							var e = a(this);
							e.is('[data-toggle="dropdown"]') && e.dataSM("bs-data-toggle-dropdown", !0).removeAttr("data-toggle"), !t && e.hasClass("dropdown-toggle") && e.dataSM("bs-dropdown-toggle", !0).removeClass("dropdown-toggle")
						})
					}

					function s(e) {
						var t = o.getViewportWidth();
						(t != i || e) && (o.isCollapsible() ? n.addClass("sm-collapsible") : n.removeClass("sm-collapsible"), i = t)
					}
					n.smartmenus({
						...
						rightToLeftSubMenus: e,
						bottomToTopSubMenus: 0 < n.closest(".fixed-bottom").length,
						bootstrapHighlightClasses: "text-dark bg-light"
					}).on({
						"show.smapi": function (e, t) {
							var n = a(t),
								i = n.dataSM("scroll-arrows");
							i && i.css("background-color", n.css("background-color")), n.parent().addClass("show"), o.opts.keepHighlighted && 2 < n.dataSM("level") && n.prevAll("a").addClass(o.opts.bootstrapHighlightClasses)
						},
						"hide.smapi": function (e, t) {
							var n = a(t);
							n.parent().removeClass("show"), o.opts.keepHighlighted && 2 < n.dataSM("level") && n.prevAll("a").removeClass(o.opts.bootstrapHighlightClasses)
						}
					}), o = n.data("smartmenus"), r(), o.refresh = function () {
						a.SmartMenus.prototype.refresh.call(this), r(), s(!0)
						...
						}), a.SmartMenus.prototype.destroy.call(this, e)
					}, t && (o.opts.collapsibleBehavior = "toggle"), s(), a(window).on("resize.smartmenus" + o.rootId, s)
				}
			}), e.length && !a.SmartMenus.Bootstrap.keydownFix && (a(document).off("keydown.bs.dropdown.data-api", ".dropdown-menu"), a.fn.dropdown && a.fn.dropdown.Constructor && a(document).on("keydown.bs.dropdown.data-api", ".dropdown-menu.show", a.fn.dropdown.Constructor._dataApiKeydownHandler), a.SmartMenus.Bootstrap.keydownFix = !0)
		}
...
function (p) {
	p.marquee = {
		version: "1.0.01"
	}, p.fn.marquee = function (e) {
		var n, i = "string" == typeof e && e,
			o = i && Array.prototype.slice.call(arguments, 1) || arguments,
			r = 0 == this.length ? null : p.data(this[0], "marquee");
		return r && i && this.length ? "object" == i.toLowerCase() ? r : r[i] ? (this.each(function (e) {
			var t = p.data(this, "marquee")[i].apply(r, o);
			if (0 == e && t) {
				if (!t.jquery) return n = t, !1;
				n = p([]).add(t)
			} else t && t.jquery && (n = n.add(t))
		}), n || this) : this : this.each(function () {
			new p.Marquee(this, e)
		})
	}, p.Marquee = function (e, o) {
		o = p.extend({}, p.Marquee.defaults, o);
		var i = this,
			r = p(e),
			s = r.find("> li"),
			t = -1,
		...
		function u(i, e) {
			if (1 == a) return !1;
			e = e || o.pauseSpeed, i.outerWidth() > r.innerWidth() ? setTimeout(function () {
				if (1 == a) return !1;
				var e = i.outerWidth(),
					t = -1 * e,
					n = parseInt(i.css("left"), 10);
				i.animate({
					left: t + "px"
				}, (e + n) * o.scrollSpeed, o.fxEasingScroll, function () {
					c(i)
				})
			}, e) : 1 < s.length && setTimeout(function () {
				if (1 == a) return !1;
				i.animate({
					top: ("top" == o.yScroll ? "+" : "-") + r.innerHeight() + "px"
				}, o.showSpeed, o.fxEasingScroll), c(i)
			}, e)
		}

		function c(e) {
			p.isFunction(o.aftershow) && o.aftershow.apply(i, [r, e]), e.removeClass(o.cssShowing), f()
		}

		function h() {
			a = !0, 1 != r.data("marquee.showing") && s.filter("." + o.cssShowing).dequeue().stop()
		}

		function d() {
			a = !1, 1 != r.data("marquee.showing") && u(s.filter("." + o.cssShowing), 1)
		}

		function f() {
			if (++t >= s.length) {
				if (!isNaN(o.loop) && 0 < o.loop && ++l >= o.loop) return !1;
				t = 0
			}! function (e) {
				if (0 < s.filter("." + o.cssShowing).length) return;
				var t = s.eq(e);
				p.isFunction(o.beforeshow) && o.beforeshow.apply(i, [r, t]);
				var n = {
					top: ("top" == o.yScroll ? "-" : "+") + t.outerHeight() + "px",
					left: 0
				};
				r.data("marquee.showing", !0), t.addClass(o.cssShowing), t.css(n).animate({
					top: "0px"
				}, o.showSpeed, o.fxEasingShow, function () {
					p.isFunction(o.show) && o.show.apply(i, [r, t]), r.data("marquee.showing", !1), u(t)
				})
			}(t)
		}
		p.data(r[0], "marquee", i), this.pause = function () {
			n = !0, h()
			...
			var e = s.length;
			s = r.find("> li"), e <= 1 && d()
		}, o.pauseOnHover && r.hover(function () {
			if (n) return !1;
			h()
		}, function () {
			if (n) return !1;
			d()
		}), p.isFunction(o.init) && o.init.apply(i, [r, o]), f()
	}, p.Marquee.defaults = {
		yScroll: "top",
		showSpeed: 850,
		scrollSpeed: 12,
...
function check_options(e) {
	var t = $("#" + (1 == e ? "first" : "second") + "_choice_id");
	if (1 == e) {
		var n = $("#second_choice_id");
		n.val() == t.val() && n.val("")
	} else {
		var i = $("#first_choice_id");
		i.val() == t.val() && i.val("")
	}
}

function change_country_field() {
	var e = $("#citizenship").val(),
		t = $(".country");
	"WNA" == e ? t.show() : t.hide()
}
...
function send_message() {
	...
	_RECAPTCHA_STATUS && (e.recaptcha = $('textarea[name="g-recaptcha-response"]').val()), _H.Loading(!0), $.post(_BASE_URL + "hubungi-kami/save", e, function (e) {
		_H.Loading(!1);
		var t = _H.StrToObject(e);
		_H.Notify(t.status, t.message), "success" == t.status && $('input[type="text"], input[type="email"], textarea').val(""), _RECAPTCHA_STATUS && grecaptcha.reset()
	})
}
...
function post_comments() {
	...
	_RECAPTCHA_STATUS && (e.recaptcha = $('textarea[name="g-recaptcha-response"]').val()), _H.Loading(!0), $.post(_BASE_URL + "public/post_comments", e, function (e) {
		_H.Loading(!1);
		var t = _H.StrToObject(e);
		_H.Notify(t.status, t.message), "success" == t.status && $('input[type="text"], input[type="email"], textarea').val(""), _RECAPTCHA_STATUS && grecaptcha.reset()
	})
...
function alumni_registration() {
	...
	e.append("photo", $('input[name="photo"]')[0].files[0]), e.append("full_name", $("#full_name").val()), e.append("gender", $("#gender").val()), e.append("birth_date", $("#birth_date").val()), e.append("end_date", $("#end_date").val()), e.append("identity_number", $("#identity_number").val()), e.append("street_address", $("#street_address").val()), e.append("phone", $("#phone").val()), e.append("mobile_phone", $("#mobile_phone").val()), e.append("email", $("#email").val()), _RECAPTCHA_STATUS && e.append("recaptcha", $('textarea[name="g-recaptcha-response"]').val()), $.ajax({
		...
		success: function (e) {
			_H.Loading(!1);
			var t = _H.StrToObject(e);
			"success" == t.status && $(document).find("input, textarea").val(""), _H.Notify(t.status, t.message), _RECAPTCHA_STATUS && grecaptcha.reset()
		}
	})
}

function photo_preview(e) {
	_H.Loading(!0), $.post(_BASE_URL + "public/gallery_photos/preview", {
		id: e
	}, function (e) {
...
function subscribe() {
	...
	$.post(_BASE_URL + "subscribe", e, function (e) {
		var t = _H.StrToObject(e);
		"token_error" == t.status ? window.location.reload(!0) : (_H.Loading(!1), _H.Notify(t.status, t.message), $("#subscriber").val(""), $('meta[name="csrf-token"]').attr("content", t.csrf_token))
	})
}
...
function vote() {
	...
	e.answer_id ? (_H.Loading(!0), $.post(_BASE_URL + "vote", e, function (e) {
		_H.Loading(!1);
		var t = _H.StrToObject(e);
		"token_error" == t.status ? window.location.reload(!0) : (_H.Notify(t.status, t.message), $('meta[name="csrf-token"]').attr("content", t.csrf_token), $("input[name=answer_id]").prop("checked", !1))
...
function print_registration_form() {
	...
	_RECAPTCHA_STATUS && (e.recaptcha = $('textarea[name="g-recaptcha-response"]').val()), $.post(_BASE_URL + "public/print_admission_form/process", e, function (e) {
		var t = _H.StrToObject(e);
		"success" == t.status ? window.open(_BASE_URL + "media_library/students/" + t.file_name, "_self") : (_H.Notify(t.status, t.message), _H.Loading(!1), _RECAPTCHA_STATUS && grecaptcha.reset())
	})
}

function admission_selection_results() {
	var e = {
		birth_date: $("#birth_date").val(),
		registration_number: $("#registration_number").val()
	};
	_RECAPTCHA_STATUS && (e.recaptcha = $('textarea[name="g-recaptcha-response"]').val()), _H.Loading(!0), $.post(_BASE_URL + "admission-selection-results", e, function (e) {
		_H.Loading(!1);
		var t = _H.StrToObject(e);
		_H.Notify(t.status, t.message), _RECAPTCHA_STATUS && grecaptcha.reset()
	})
}
...
function student_registration() {
	_H.Loading(!0);
	var e = new FormData;
	e.append("is_transfer", $("#is_transfer").val()),
		e.append("admission_type_id", $("#admission_type_id").val()),
		e.append("full_name", $("#full_name").val()),
		e.append("gender", $("#gender").val()),
		e.append("birth_date", $("#birth_date").val()),
		e.append("district", $("#district").val()),
		$("#photo").length && e.append("photo", $('input[name="photo"]')[0].files[0]),
		$("#first_choice_id").length && e.append("first_choice_id", $("#first_choice_id").val()),
		$("#second_choice_id").length && e.append("second_choice_id", $("#second_choice_id").val()),
		$("#nisn").length && e.append("nisn", $("#nisn").val()),
		$("#nkk").length && e.append("nkk", $("#nkk").val()),
		$("#nik").length && e.append("nik", $("#nik").val()),
		$("#prev_exam_number").length && e.append("prev_exam_number", $("#prev_exam_number").val()),
		$("#prev_school_name").length && e.append("prev_school_name", $("#prev_school_name").val()),
		$("#tahun_lulus").length && e.append("tahun_lulus", $("#tahun_lulus").val()),
		$("#prev_school_address").length && e.append("prev_school_address", $("#prev_school_address").val()),
		$("#achievement").length && e.append("achievement", $("#achievement").val()),
		$("#paud").length && e.append("paud", $("#paud").val()),
		$("#tk").length && e.append("tk", $("#tk").val()),
		$("#skhun").length && e.append("skhun", $("#skhun").val()),
		$("#prev_diploma_number").length && e.append("prev_diploma_number", $("#prev_diploma_number").val()),
		$("#hobby").length && e.append("hobby", $("#hobby").val()),
		$("#ambition").length && e.append("ambition", $("#ambition").val()),
		$("#birth_place").length && e.append("birth_place", $("#birth_place").val()),
		$("#religion_id").length && e.append("religion_id", $("#religion_id").val()),
		$("#special_need_id").length && e.append("special_need_id", $("#special_need_id").val()),
		$("#street_address").length && e.append("street_address", $("#street_address").val()),
		$("#rt").length && e.append("rt", $("#rt").val()),
		$("#rw").length && e.append("rw", $("#rw").val()),
		$("#sub_village").length && e.append("sub_village", $("#sub_village").val()),
		$("#village").length && e.append("village", $("#village").val()),
		$("#sub_district").length && e.append("sub_district", $("#sub_district").val()),
		$("#postal_code").length && e.append("postal_code", $("#postal_code").val()),
		$("#residence_id").length && e.append("residence_id", $("#residence_id").val()),
		$("#transportation_id").length && e.append("transportation_id", $("#transportation_id").val()),
		$("#phone").length && e.append("phone", $("#phone").val()),
		$("#mobile_phone").length && e.append("mobile_phone", $("#mobile_phone").val()),
		$("#email").length && e.append("email", $("#email").val()),
		$("#sktm").length && e.append("sktm", $("#sktm").val()),
		$("#kks").length && e.append("kks", $("#kks").val()),
		$("#kps").length && e.append("kps", $("#kps").val()),
		$("#kip").length && e.append("kip", $("#kip").val()),
		$("#kis").length && e.append("kis", $("#kis").val()),
		$("#citizenship").length && e.append("citizenship", $("#citizenship").val()),
		$("#country").length && e.append("country", $("#country").val()),
		$("#father_name").length && e.append("father_name", $("#father_name").val()),
		$("#nik_father").length && e.append("nik_father", $("#nik_father").val()),
		$("#father_birth_year").length && e.append("father_birth_year", $("#father_birth_year").val()),
		$("#father_education_id").length && e.append("father_education_id", $("#father_education_id").val()),
		$("#father_employment_id").length && e.append("father_employment_id", $("#father_employment_id").val()),
		$("#father_monthly_income_id").length && e.append("father_monthly_income_id", $("#father_monthly_income_id").val()),
		$("#father_special_need_id").length && e.append("father_special_need_id", $("#father_special_need_id").val()),
		$("#mother_name").length && e.append("mother_name", $("#mother_name").val()),
		$("#nik_mother").length && e.append("nik_mother", $("#nik_mother").val()),
		$("#mother_birth_year").length && e.append("mother_birth_year", $("#mother_birth_year").val()),
		$("#mother_education_id").length && e.append("mother_education_id", $("#mother_education_id").val()),
		$("#mother_employment_id").length && e.append("mother_employment_id", $("#mother_employment_id").val()),
		$("#mother_monthly_income_id").length && e.append("mother_monthly_income_id", $("#mother_monthly_income_id").val()),
		$("#mother_special_need_id").length && e.append("mother_special_need_id", $("#mother_special_need_id").val()),
		$("#guardian_name").length && e.append("guardian_name", $("#guardian_name").val()),
		$("#nik_guardian").length && e.append("nik_guardian", $("#nik_guardian").val()),
		$("#guardian_birth_year").length && e.append("guardian_birth_year", $("#guardian_birth_year").val()),
		$("#guardian_education_id").length && e.append("guardian_education_id", $("#guardian_education_id").val()),
		$("#guardian_employment_id").length && e.append("guardian_employment_id", $("#guardian_employment_id").val()),
		$("#guardian_monthly_income_id").length && e.append("guardian_monthly_income_id", $("#guardian_monthly_income_id").val()),
		$("#address_parent").length && e.append("address_parent", $("#address_parent").val()),
		$("#mileage").length && e.append("mileage", $("#mileage").val()),
		$("#traveling_time").length && e.append("traveling_time", $("#traveling_time").val()),
		$("#height").length && e.append("height", $("#height").val()),
		$("#weight").length && e.append("weight", $("#weight").val()),
		$("#lingkar_kpl").length && e.append("lingkar_kpl", $("#lingkar_kpl").val()),
		$("#sibling_number").length && e.append("sibling_number", $("#sibling_number").val()),
		$("#anak_ke").length && e.append("anak_ke", $("#anak_ke").val()),
		$("#bhs_indo").length && e.append("bhs_indo", $("#bhs_indo").val()),
		$("#bhs_inggris").length && e.append("bhs_inggris", $("#bhs_inggris").val()),
		$("#mtk").length && e.append("mtk", $("#mtk").val()),
		$("#ipa").length && e.append("ipa", $("#ipa").val()),
		$("#no_akta").length && e.append("no_akta", $("#no_akta").val()),
		$("#phone_father").length && e.append("phone_father", $("#phone_father").val()),
		$("#phone_mother").length && e.append("phone_mother", $("#phone_mother").val()),
		$("#phone_guardian").length && e.append("phone_guardian", $("#phone_guardian").val()),
		e.append("declaration", $("#declaration").prop("checked")), _RECAPTCHA_STATUS && e.append("recaptcha", $('textarea[name="g-recaptcha-response"]').val()),
		$.ajax({
		url: _BASE_URL + "student-registration",
		type: "POST",
		data: e,
		contentType: !1,
		processData: !1,
		success: function (e) {
			_H.Loading(!1);
			var t = _H.StrToObject(e);
			_H.Notify(t.status, t.message), "success" == t.status && window.open(_BASE_URL + "number-student-registration/" + t.no_registrasi, "_self"), _RECAPTCHA_STATUS && grecaptcha.reset()
		}
	})
}
_H.StrToObject = function (v) {
	...
	$('a[href="#search_form"]').on("click", function (e) {
		e.preventDefault(), $("#search_form").addClass("open"), $('#search_form > form > input[type="search_form"]').focus()
	}), $("#search_form").on("click keyup", function (e) {
	...
	$('[data-toggle="sticky-menu"]').each(function () {
		...
		e.before(t), e.addClass("sticky"), $(window).on("scroll.sticky-menu resize.sticky-menu", function () {
			n(e, t, $(this))
		}), n(e, t, $(window))
	}), $("#quote").length && $("#quote").marquee();
	var i = $("#return-to-top");
	$(window).scroll(function () {
		50 <= $(this).scrollTop() ? i.fadeIn(200) : i.fadeOut(200)
	}), i.click(function () {
		$("body,html").animate({
			scrollTop: 0
		}, 500)
