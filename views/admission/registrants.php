...
form_fields.push(
	...
	{ label:'Kartu Keluarga', name:'nkk', placeholder:'No. Kartu Keluarga' },
	{ label:'NIK', name:'nik', placeholder:'No. KTP' },
	{ label:'No. KK', name:'no_akta', placeholder:'No. Akta Kelahiran' },
	...
	{ label:'Nama Sekolah Asal', name:'prev_school_name', placeholder:'Nama Sekolah Asal'},
	{ label:'Tahun Lulus Sekolah Sebelumnya', name:'tahun_lulus', placeholder:'Tahun Lulus Sekolah SMP / Sederajat'},
	...
	// { label:'Bahasa Indonesia', name:'bhs_indo', placeholder:'Bahasa Indonesia' },
	// { label:'Bahasa Inggris', name:'bhs_inggris', placeholder:'Bahasa Inggris' },
	// { label:'Matematika', name:'mtk', placeholder:'Matematika' },
	// { label:'IPA', name:'ipa', placeholder:'IPA' },
	...
	{ label:'NIK Ayah', name:'nik_father', placeholder:'NIK Ayah' },
	{ label:'Tahun Lahir Ayah', name:'father_birth_year', placeholder:'Tahun Lahir' },
	{ label:'No. Handphone Ayah', name:'phone_father', placeholder:'No HP Ayah' },
	...
	{ label:'NIK Ibu', name:'nik_mother', placeholder:'NIK Ibu' },
	{ label:'Tahun Lahir Ibu', name:'mother_birth_year', placeholder:'Tahun Lahir' },
	{ label:'No. Handphone Ibu', name:'phone_mother', placeholder:'No HP Ibu' },
	...
	{ label:'Alamat Orang Tua / Wali', name:'address_parent', placeholder:'Alamat Orang Tua / Wali' },
	...
	{ label:'Lingkar Kepala', name:'lingkar_kpl', placeholder:'Berat Badan', type:'number' },
	{ label:'Jumlah Saudara Kandung', name:'sibling_number', placeholder:'Jumlah Saudara Kandung', type:'number' },
	{ label:'Anak Ke-', name:'anak_ke', placeholder:'Jumlah Saudara Kandung', type:'number' }
);
