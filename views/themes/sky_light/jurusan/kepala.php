<div class="bg-white p-3 my-2">
	...
	<?php if ( ! in_array($this->uri->segment(1), ['sambutan-kepala-sekolah', 'sambutan-rektor', 'sambutan-ketua', 'sambutan-direktur'])) { ?>
		<div class="card border-0">
			<img src="<?=base_url('media_library/images/').__session('headmaster_photo');?>" class="card-img-top rounded-3">
			<div class="card-body px-0 pb-0">
				...
				<p class="card-text text-justify"><?=word_limiter(strip_tags(get_opening_speech()), 20);?>
                <a href="<?=site_url(opening_speech_route());?>" class="small">Baca Selengkapnya</a></p>
			</div>
		</div>
	<?php } ?>
</div>
